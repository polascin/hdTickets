...
document.addEventListener('alpine:init', () => {
    Alpine.data('welcomePage', () => ({
        ...
        detectTheme() {
            ...
            this.darkMode = savedTheme === 'dark' || (!savedTheme && systemTheme === 'dark');
            this.applyTheme();
        },
        ...
        animateStatsCount() {
            ...
            statElements.forEach((element, index) => {
                ...
                const timer = setInterval(() => {
                    current += increment;
                    if (current >= parseInt(finalValue) || isNaN(parseInt(finalValue))) {
        ...
        cycleTeamTheme() {
            ...
            document.querySelectorAll('.feature-card').forEach(card => {
                card.className = card.className.replace(/team-color-\\w+/, `team-color-${this.currentTheme}`);
            });
        },
        ...
        initIntersectionObserver() {
            ...
            // Observe elements
            document.querySelectorAll('.feature-card, .stats-bar, .hero-logo').forEach(el => {
                observer.observe(el);
            });
        },
...
window.addEventListener('online', () => {
    document.dispatchEvent(new CustomEvent('online-status-change', { detail: true }));
});

window.addEventListener('offline', () => {
    document.dispatchEvent(new CustomEvent('online-status-change', { detail: false }));
});
