...
if (echo.connector && echo.connector.pusher) {
    ...
    pusher.connection.bind('error', (error) => {
        ...
        // Dispatch custom event
        document.dispatchEvent(new CustomEvent('echo:error', {
            detail: { error }
        }));
    ...
    pusher.connection.bind('state_change', (states) => {
        ...
        // Dispatch custom event
        document.dispatchEvent(new CustomEvent('echo:state_change', {
            detail: states
        }));
    });
}
...
window.EchoHelpers = {
    ...
    subscribeToTicket(ticketId, callbacks = {}) {
        ...
        if (callbacks.onAvailabilityChange) {
            channel.listen('TicketAvailabilityChanged', callbacks.onAvailabilityChange);
        }
