    ...
    <div class="flex items-center space-x-4 text-sm">
      <template x-data="{ currentStep: 1 }">
        <div class="flex items-center space-x-2">
          <div class="w-6 h-6 bg-blue-500 text-white rounded-full flex items-center justify-center text-xs font-medium">1
          </div>
        ...
        <div class="flex items-center space-x-2">
          <div
            class="w-6 h-6 border-2 border-gray-300 dark:border-gray-600 rounded-full flex items-center justify-center text-xs font-medium">
            2</div>
      ...
      <div class="flex items-center justify-between mb-4">
        <div class="flex items-center space-x-4">
          <template x-for="(step, index) in steps" :key="index">
            <div class="flex items-center space-x-2">
              <div class="flex items-center space-x-2"
                :class="currentStep === index + 1 ? 'text-blue-600 dark:text-blue-400' : currentStep > index + 1 ?
                    'text-green-600 dark:text-green-400' : 'text-gray-400 dark:text-gray-500'">
                <div class="w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium"
                  :class="currentStep === index + 1 ? 'bg-blue-500 text-white' : currentStep > index + 1 ?
      ...
      <div class="lg:col-span-2 space-y-6">
        ...
        <div x-show="currentStep === 1" x-transition class="hdt-card">
          <div class="hdt-card__header">
            ...
            <span class="hdt-badge hdt-badge--info hdt-badge--sm"
              x-text="selectedEvent.availableTickets + ' available'"></span>
          </div>
            ...
            <div class="flex items-center space-x-4 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg mb-6">
              ...
              <div class="flex-1">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400"
                  x-text="selectedEvent.venue + ' • ' + selectedEvent.date + ' • ' + selectedEvent.time"></p>
                <p class="text-sm text-gray-500 dark:text-gray-400" x-text="selectedEvent.platform"></p>
              </div>
              <div class="text-right">
                <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">$<span
                    x-text="selectedEvent.basePrice"></span></p>
            ...
            <div class="space-y-4">
              ...
              <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
                <div class="text-center mb-4">
                  <div
                    class="inline-block px-4 py-2 bg-gray-200 dark:bg-gray-700 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300">
                    🎪 STAGE / FIELD
                  </div>
                </div>
                ...
                <div class="grid grid-cols-12 gap-1 max-w-2xl mx-auto">
                  <template x-for="seat in availableSeats" :key="seat.id">
                    <button @click="toggleSeat(seat)"
                      ...
                      :class="getSeatClass(seat)" :disabled="seat.status === 'taken'"
          ...
          <div class="hdt-card__footer">
            <div class="flex justify-between items-center">
              <div>
                <p class="text-sm text-gray-600 dark:text-gray-400">
                  Selected: <span class="font-medium text-gray-900 dark:text-gray-100"
                    x-text="selectedSeats.length + ' seats'"></span>
                </p>
              </div>
        ...
        <div x-show="currentStep === 2" x-transition class="hdt-card">
          ...
          <div class="hdt-card__body">
            <form @submit.prevent="nextStep()" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mt-2">
                  <template x-for="method in deliveryMethods" :key="method.id">
                    <label class="flex items-center p-4 border rounded-lg cursor-pointer transition-colors"
                      :class="customerInfo.deliveryMethod === method.id ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' :
                          'border-gray-200 dark:border-gray-700'">
                      <input type="radio" :value="method.id" x-model="customerInfo.deliveryMethod"
                        class="sr-only">
                      <div class="flex-1">
                        <div class="flex items-center space-x-2">
                          <svg class="w-5 h-5 text-gray-600 dark:text-gray-400" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24" x-html="method.icon"></svg>
                        ...
                        <p class="text-sm font-medium text-green-600 dark:text-green-400"
                          x-text="method.price === 0 ? 'Free' : '$' + method.price"></p>
                      </div>
                    </label>
                  </template>
                </div>
              ...
              <div class="hdt-form-group">
                ...
                <textarea x-model="customerInfo.specialRequests" rows="3" class="hdt-input"
          ...
          <div class="hdt-card__footer">
            <div class="flex justify-between items-center">
              ...
              <button @click="nextStep()" :disabled="!isCustomerInfoValid()"
                class="hdt-button hdt-button--primary hdt-button--md"
            ...
            <div class="space-y-6">
              <div class="hdt-form-group">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mt-2">
                  <label class="flex items-center p-4 border rounded-lg cursor-pointer transition-colors"
                    :class="paymentMethod === 'card' ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' :
                        'border-gray-200 dark:border-gray-700'">
                  ...
                  <label class="flex items-center p-4 border rounded-lg cursor-pointer transition-colors"
                    :class="paymentMethod === 'paypal' ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' :
                        'border-gray-200 dark:border-gray-700'">
              ...
              <div x-show="paymentMethod === 'paypal'" x-transition
                class="text-center p-8 border border-dashed border-gray-300 dark:border-gray-600 rounded-lg">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">You'll be redirected to PayPal to complete your
                  purchase securely</p>
              </div>
            </div>
          </div>
        ...
        <div class="hdt-card sticky top-6">
          ...
          <div class="hdt-card__body space-y-4">
            ...
            <div class="pb-4 border-b border-gray-200 dark:border-gray-700">
              ...
              <p class="text-sm text-gray-600 dark:text-gray-400"
                x-text="selectedEvent.date + ' • ' + selectedEvent.time"></p>
            </div>
                ...
                <template x-for="seat in selectedSeats" :key="seat.id">
                  <div class="flex justify-between text-sm">
                    <span class="text-gray-600 dark:text-gray-400"
                      x-text="`Section ${seat.section}, Row ${seat.row}, Seat ${seat.number}`"></span>
  ...
  <script>
    document.addEventListener('alpine:init', () => {
      Alpine.data('purchaseWizard', () => ({
        ...
        steps: [{
            name: 'Selection',
            description: 'Choose seats and quantity'
          },
          {
            name: 'Details',
