            ...
            <div class="space-y-3">
              <div class="flex items-center justify-between">
                ...
                <span class="flex items-center text-sm">
                  <span class="w-2 h-2 bg-green-500 rounded-full mr-2" x-show="system_status && system_status.scraping_active"></span>
                  <span class="w-2 h-2 bg-red-500 rounded-full mr-2" x-show="system_status && !system_status.scraping_active"></span>
                  <span x-text="system_status && system_status.scraping_active ? 'Active' : 'Inactive'" class="text-slate-900 dark:text-slate-100">Active</span>
                </span>
              </div>
              <div class="flex items-center justify-between">
                <span class="text-sm text-slate-600 dark:text-slate-400">Database</span>
                <span class="flex items-center text-sm">
                  <span class="w-2 h-2 bg-green-500 rounded-full mr-2" x-show="system_status && system_status.database_healthy"></span>
                  <span class="w-2 h-2 bg-red-500 rounded-full mr-2" x-show="system_status && !system_status.database_healthy"></span>
                  <span x-text="system_status && system_status.database_healthy ? 'Healthy' : 'Issues'" class="text-slate-900 dark:text-slate-100">Healthy</span>
                </span>
              </div>
              <div class="flex items-center justify-between">
          ...
          <div class="dashboard-glass rounded-xl p-6">
            ...
            <div class="space-y-3">
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-medium text-slate-900 dark:text-slate-100">{{ $subscription_data['plan_name'] }}</span>
              </div>
              <div class="flex items-center justify-between">
