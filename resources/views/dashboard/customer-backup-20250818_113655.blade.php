...
@section('content')
  ...
  <div data-realtime="true">
    @php
      ...
      $highDemandTickets = \App\Models\ScrapedTicket::where('is_high_demand', true)
          ->where('is_available', true)
          ->count();
      $userPurchaseQueue = \App\Models\PurchaseQueue::where('selected_by_user_id', Auth::id())
          ->where('status', 'queued')
          ->count();
    @endphp
    ...
    <main class="dashboard-container" data-user-id="{{ Auth::id() }}" data-realtime-enabled="true">
        ...
        <div class="welcome-banner bg-gradient-to-r from-green-500 to-blue-600 rounded-xl p-6 text-white mb-8">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-green-100">Comprehensive Sport Events Entry Tickets Monitoring, Scraping and Purchase System
              </p>
            </div>
      ...
      <section class="stats-section" data-section="stats" data-realtime="statistics">
        <div class="stats-grid grid grid-cols-1 md:grid-cols-4 gap-6 mb-8" data-refresh="true">
          ...
          <div class="stat-card stat-available-tickets" data-stat-type="available-tickets"
            data-value="{{ $availableTickets }}">
          ...
          <div class="actions-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6" data-actions="quick-nav">
            <div class="action-card browse-tickets" data-action="browse" data-hook="action-browse">
              <a href="{{ route('tickets.scraping.index') }}" class="action-link">
                <div
                  class="group bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl border border-blue-200 hover:shadow-lg transition-all duration-200">
                  <div class="flex items-center">
                    <div class="flex-shrink-0">
                      <div
                        class="w-12 h-12 bg-blue-500 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-200">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a1 1 0 001 1h1a1 1 0 001-1V7a2 2 0 00-2-2H5zM5 14a2 2 0 00-2 2v3a1 1 0 001 1h1a1 1 0 001-1v-3a2 2 0 00-2-2H5z">
                          </path>
            ...
            <div class="recent-tickets-list" data-refresh="true" data-live-updates="tickets">
                      ...
                      <div class="ml-4 flex-1 min-w-0">
                        <div class="flex items-center justify-between">
                          <div>
                            ...
                            @if ($ticket->price)
                              <p class="text-sm font-semibold text-green-600">${{ number_format($ticket->price, 2) }}
                              </p>
                            @endif
                          </div>
              ...
              @else
                <div class="text-center py-12" data-empty-state="no-tickets">
                  ...
                  <p class="mt-1 text-sm text-gray-500">Check back soon for new sport event tickets or set up an alert.
                  </p>
                  <div class="mt-6">
