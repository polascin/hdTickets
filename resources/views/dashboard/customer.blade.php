...
<x-dashboard.layout title="Sports Ticket Hub" subtitle="Find, track, and purchase the best sports event tickets">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <x-dashboard.stat-card 
            ...
            value="{{ number_format($availableTickets) }}" 
        ...
        <x-dashboard.stat-card 
            title="High Demand" 
            value="{{ number_format($highDemandTickets) }}" 
        ...
        <x-dashboard.stat-card 
            title="Active Alerts" 
            value="{{ $userAlerts }}" 
            icon="<svg class='w-6 h-6 text-white' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M15 17h5l-5 5v-5zM12 17H7a3 3 0 01-3-3V5a3 3 0 013-3h5' /></svg>" 
            color="blue" 
        />

        <x-dashboard.stat-card 
            title="In Queue" 
            value="{{ $userPurchaseQueue }}" 
            icon="<svg class='w-6 h-6 text-white' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17M17 13a2 2 0 100 4 2 2 0 000-4zm-8 4a2 2 0 11-4 0 2 2 0 014 0z' /></svg>" 
            color="purple" 
        />
    </div>
