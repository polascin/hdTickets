      ...
      <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-4 lg:space-y-0">
        ...
        <div class="flex items-center space-x-4">
          ...
          <button @click="refreshData()" :disabled="isLoading"
            ...
            <svg :class="{ 'animate-spin': isLoading }" class="w-5 h-5 mr-2" fill="none" stroke="currentColor"
              viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<div class="py-6 space-y-6">
          ...
          <div class="flex items-center justify-center mb-3">
            <div class="relative w-16 h-16">
              <svg class="w-16 h-16 transform -rotate-90" viewBox="0 0 36 36">
                <path class="text-blue-200" stroke="currentColor" stroke-width="3" fill="none"
                  d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                <path class="text-green-400" stroke="currentColor" stroke-width="3" fill="none"
                  stroke-dasharray="98, 100"
                  d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div class="p-6 relative">
        ...
        <div class="flex items-center relative z-10">
          ...
          <div class="ml-4 flex-1">
            <div class="text-sm font-medium text-gray-600 mb-1" title="Total tickets collected from all platforms">
              Scraped Tickets</div>
            <div class="text-3xl font-bold text-gray-900 mb-1" data-counter="{{ $scrapedTickets ?? 0 }}"
              title="{{ number_format($scrapedTickets ?? 0) }} tickets collected">
              {{ number_format($scrapedTickets ?? 0) }}</div>
    ...
    <div
      ...
      <div class="p-6 relative">
        <div
          class="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-bl-full opacity-10">
        </div>
        <div class="flex items-center relative z-10">
          <div class="flex-shrink-0">
            <div
          ...
          <div class="ml-4 flex-1">
            ...
            <div class="text-3xl font-bold text-gray-900 mb-1" data-counter="{{ $activeMonitors ?? 0 }}">
              {{ number_format($activeMonitors ?? 0) }}</div>
    ...
    <div
      ...
      <div class="p-6 relative">
        <div
          class="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-red-400 to-pink-500 rounded-bl-full opacity-10">
        </div>
        <div class="flex items-center relative z-10">
          <div class="flex-shrink-0">
            <div
          ...
          <div class="ml-4 flex-1">
            ...
            <div class="text-3xl font-bold text-gray-900 mb-1" data-counter="{{ $premiumTickets ?? 0 }}">
              {{ number_format($premiumTickets ?? 0) }}</div>
    ...
    <div
      ...
      <div class="p-6 relative">
        <div
          class="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-green-400 to-emerald-500 rounded-bl-full opacity-10">
        </div>
        <div class="flex items-center relative z-10">
          <div class="flex-shrink-0">
            <div
          ...
          <div class="ml-4 flex-1">
            ...
            <div class="text-3xl font-bold text-gray-900 mb-1" data-counter="{{ $totalUsers ?? 0 }}">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    @if (Auth::user()->canManageUsers())
      <div
        class="bg-gradient-to-br from-blue-50 to-indigo-100 border-2 border-blue-200 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
        ...
        <div class="space-y-2">
          <a href="{{ route('admin.users.index') }}"
            class="block w-full bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200 text-center">
          ...
          <div class="grid grid-cols-2 gap-2">
            <a href="{{ route('admin.users.create') }}"
              class="bg-green-600 hover:bg-green-700 text-white px-3 py-1.5 rounded-md text-xs font-medium transition-colors duration-200 text-center">
            ...
            <a href="{{ route('admin.users.roles') }}"
              class="bg-indigo-600 hover:bg-indigo-700 text-white px-3 py-1.5 rounded-md text-xs font-medium transition-colors duration-200 text-center">
              <svg class="w-3 h-3 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="bg-green-50 border border-green-200 p-6 rounded-lg">
      ...
      <a href="{{ route('admin.categories.index') }}"
        class="inline-block bg-green-600 text-white px-4 py-2 rounded text-sm font-medium hover:bg-green-700">Manage
        Categories</a>
    </div>
    ...
    <div class="bg-purple-50 border border-purple-200 p-6 rounded-lg">
      ...
      <a href="#"
        class="inline-block bg-purple-600 text-white px-4 py-2 rounded text-sm font-medium hover:bg-purple-700">System
        Settings</a>
    </div>
    ...
    <div class="bg-indigo-50 border border-indigo-200 p-6 rounded-lg">
      ...
      <a href="{{ route('admin.scraping.index') }}"
        class="inline-block bg-indigo-600 text-white px-4 py-2 rounded text-sm font-medium hover:bg-indigo-700">Manage
        Scraping</a>
    </div>
    ...
    <div class="bg-yellow-50 border border-yellow-200 p-6 rounded-lg">
      ...
      <a href="{{ route('admin.system.index') }}"
        class="inline-block bg-yellow-600 text-white px-4 py-2 rounded text-sm font-medium hover:bg-yellow-700">System
        Settings</a>
    </div>
    ...
    <div class="bg-red-50 border border-red-200 p-6 rounded-lg">
      ...
      <a href="{{ route('ticket-api.index') }}"
        class="inline-block bg-red-600 text-white px-4 py-2 rounded text-sm font-medium hover:bg-red-700">Manage
        APIs</a>
    </div>
  </div>
    ...
    <div class="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-red-50 to-pink-50">
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-2">
          ...
          <div
            class="w-10 h-10 bg-gradient-to-br from-red-500 to-pink-600 rounded-lg flex items-center justify-center">
            <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<script>
  ...
  function refreshAlerts() {
    ...
    alertsContainer.innerHTML =
      '<div class="text-center py-3"><i class="fas fa-spinner fa-spin text-gray-400"></i> Loading alerts...</div>';
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    const managementCards = document.querySelectorAll(
      '.bg-blue-50, .bg-green-50, .bg-purple-50, .bg-indigo-50, .bg-yellow-50, .bg-red-50');
