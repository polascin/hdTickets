          ...
          <div class="stat-card stat-available-tickets" data-stat-type="available-tickets"
            ...
            <div class="stat-content">
              ...
              <div class="stat-info">
                ...
                <div class="stat-value" data-live-value="available-tickets">{{ number_format($availableTickets) }}
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="bg-white overflow-hidden shadow-lg rounded-xl">
          <div class="px-6 py-6">
            <div class="section-header">
              ...
              <a href="{{ route('tickets.scraping.index') }}" class="text-brand-600 hover:text-brand-700"
                ...
                <div class="space-y-4">
                  @foreach ($recentSportTickets as $ticket)
                    <div class="ticket-item" data-ticket-id="{{ $ticket->id }}"
                      data-realtime="ticket-{{ $ticket->id }}">
                      <div
                        class="availability-indicator {{ $ticket->is_available ? 'bg-green-400' : 'bg-red-400' }} {{ $ticket->is_high_demand ? 'animate-pulse' : '' }}"
