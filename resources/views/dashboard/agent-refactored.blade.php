    ...
    <div class="grid grid-cols-1 xl:grid-cols-4 gap-8">
      ...
      <div class="xl:col-span-3 space-y-6">
        ...
        <x-hdt.card>
          ...
          <div class="bg-hd-gray-50 dark:bg-hd-gray-800 -mx-6 -mt-6 mb-6 p-4 border-b border-hd-gray-200 dark:border-hd-gray-700">
          ...
          <div class="space-y-4" x-show="filteredTickets.length > 0">
            <template x-for="ticket in filteredTickets.slice(0, 10)" :key="ticket.id">
              <div class="flex items-center gap-4 p-4 border border-hd-gray-200 dark:border-hd-gray-700 rounded-lg hover:border-hd-secondary-300 dark:hover:border-hd-secondary-600 transition-colors cursor-pointer"
                   @click="openTicketDetails(ticket)">
                
                <!-- Priority Indicator -->
                <div class="flex flex-col items-center gap-1">
                  <div class="w-3 h-3 rounded-full" 
                       :class="ticket.priority === 'high' ? 'bg-red-500' : ticket.priority === 'medium' ? 'bg-yellow-500' : 'bg-green-500'"></div>
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <p class="text-sm text-hd-gray-600 dark:text-hd-gray-400 mb-2" x-text="ticket.venue + ' • ' + ticket.date"></p>
                  
                  <div class="flex items-center gap-4">
                    <div class="flex items-center gap-2">
                      <span class="text-lg font-bold" 
                            :class="ticket.price_trend === 'down' ? 'text-green-600' : ticket.price_trend === 'up' ? 'text-red-600' : 'text-hd-gray-900 dark:text-hd-gray-100'"
                            x-text="'$' + ticket.current_price"></span>
                      <span x-show="ticket.price_change" 
            ...
            <template x-for="item in purchaseQueue" :key="item.id">
              <div class="flex items-center gap-4 p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                <div class="flex-1 min-w-0">
                  ...
                  <p class="text-sm text-hd-gray-600 dark:text-hd-gray-400" x-text="'$' + item.price + ' • ' + item.quantity + ' tickets'"></p>
      ...
      <div class="space-y-6">
        ...
        <x-hdt.card>
          ...
          <div class="space-y-4">
            ...
            <div class="flex items-center justify-between">
              ...
              <span class="font-bold text-hd-gray-900 dark:text-hd-gray-100" x-text="weeklyStats.avgResponse + 's'"></span>
            </div>
          </div>
        </x-hdt.card>
        ...
        <x-hdt.card>
          ...
          <x-slot:subtitle>
            <a href="/alerts" class="text-hd-secondary-600 hover:text-hd-secondary-700 text-sm font-medium">Manage All</a>
          </x-slot:subtitle>
    ...
    <div x-show="showShortcuts" 
      ...
      <x-hdt.card class="max-w-md">
        ...
        <div class="space-y-2 text-sm">
          <div class="flex justify-between"><span>Search</span><kbd class="px-2 py-1 bg-hd-gray-200 rounded">⌘K</kbd></div>
          <div class="flex justify-between"><span>Create Alert</span><kbd class="px-2 py-1 bg-hd-gray-200 rounded">⌘A</kbd></div>
          <div class="flex justify-between"><span>Refresh Data</span><kbd class="px-2 py-1 bg-hd-gray-200 rounded">⌘R</kbd></div>
          <div class="flex justify-between"><span>Toggle Shortcuts</span><kbd class="px-2 py-1 bg-hd-gray-200 rounded">?</kbd></div>
        </div>
        <x-slot:actions>
