    ...
    <div class="analytics-hero text-white py-8 px-6 rounded-2xl mb-8 relative z-10">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div>
                ...
                <p class="text-white/90 text-lg mb-4">Advanced insights into your sports ticket monitoring and purchasing activities</p>
                    ...
                    <div class="flex items-start">
                        <div class="w-8 h-8 bg-orange-100 rounded-full flex items-center justify-center mr-3 mt-1">
                            <svg class="w-4 h-4 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 17h5l-5 5v-5zM12 17H7a3 3 0 01-3-3V5a3 3 0 013-3h5"></path>
                            </svg>
                        </div>
                        <div>
