...
@section('content')
  <div id="enhanced-customer-dashboard" x-data="enhancedCustomerDashboard()" x-init="init()" class="customer-dashboard">
    ...
    <div class="glass-card p-6 mb-6">
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3">
          <button @click="refreshDashboard()" :disabled="loading" class="btn-primary">
          ...
          <button @click="showNotifications = !showNotifications" class="uiv2-icon-btn relative"
      ...
      <div class="lg:col-span-2 space-y-6">
        ...
        <div class="dashboard-section p-6">
          <div class="flex items-center justify-between mb-4">
            ...
            <a href="{{ route('tickets.main') }}" class="text-sm text-indigo-600 hover:text-indigo-700 font-medium">View
              all</a>
          </div>
