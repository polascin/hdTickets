        ...
        <div class="flex justify-between items-center">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                    {{ __('Sports Ticket Information Portal') }}
                </h2>
                <p class="text-sm text-gray-600 mt-1">Your gateway to sports events and ticket information</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white overflow-hidden shadow-lg rounded-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 text-sm mb-4">Stay updated with the latest sports events and ticket availability information.</p>
                ...
                <div class="bg-white overflow-hidden shadow-lg rounded-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
                    <div class="p-6">
                        ...
                        <a href="{{ route('profile.edit') }}" class="inline-flex items-center text-blue-600 text-sm font-medium hover:text-blue-700">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-amber-700">
                            <p>Your current account role ({{ ucfirst(Auth::user()->role) }}) provides access to basic account information and settings. For additional features and administrative access, please contact your system administrator.</p>
                        </div>
                    </div>
                </div>
            </div>
