...
<html lang="en">
  ...
  <head>
    ...
    <!-- Tailwind CDN removed: legacy utilities replaced by compiled design system / tw-legacy.css -->
  ...
  <body class="bg-gray-50">
    ...
    <x-mobile-layout title="Mobile Demo" :showBackButton="false" :showSearch="true" :showUserMenu="true" :pullToRefresh="true"
      :swipeGestures="true" searchPlaceholder="Search sports tickets...">
      <div class="space-y-6">
        <!-- Header -->
        ...
        <div class="demo-section">
          ...
          <form class="mobile-form space-y-4">
            ...
            <div class="mobile-form-group">
              ...
              <textarea class="mobile-form-textarea" rows="3" maxlength="200" placeholder="Type your message here..."></textarea>
            </div>
        ...
        <div class="demo-section">
          ...
          <div
            class="swipe-container bg-gradient-to-r from-blue-500 to-purple-600 text-white p-6 rounded-lg text-center"
        ...
        <div class="demo-section">
          ...
          <div class="mobile-accordion mt-6" data-exclusive="true">
            ...
            <div class="mobile-accordion-item">
              ...
              <div class="mobile-accordion-content">
                <div class="mobile-accordion-body">
                  <p>Our refund policy varies by event. Most tickets are non-refundable unless the event is cancelled.
                  </p>
                </div>
              </div>
            </div>
              ...
              <tbody>
                <tr>
                  ...
                  <td data-label="Status"><span
                      class="bg-green-100 text-green-800 px-2 py-1 rounded text-sm">Available</span></td>
                </tr>
                <tr>
                  ...
                  <td data-label="Status"><span
                      class="bg-yellow-100 text-yellow-800 px-2 py-1 rounded text-sm">Limited</span></td>
                </tr>
                <tr>
                  ...
                  <td data-label="Status"><span class="bg-red-100 text-red-800 px-2 py-1 rounded text-sm">Sold
                      Out</span></td>
                </tr>
              </tbody>
            </table>
