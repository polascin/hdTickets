      ...
      <div class="max-w-md w-full">
        ...
        <div x-show="currentStep === 1" x-transition class="bg-white rounded-2xl shadow-xl p-8">
          <div class="text-center mb-8">
            ...
            <p class="text-gray-600">Enter your email address and we'll send you a secure link to reset your password</p>
          </div>
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input type="email" 
                       ...
                       :class="emailError ? 'border-red-300 ring-red-500' : ''"
                       autocomplete="email"
                       required>
              </div>
        ...
        <div x-show="currentStep === 2" x-transition class="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                  <div class="text-2xl font-mono font-bold text-yellow-900" x-text="formatTime(timeRemaining)">59:00</div>
          ...
          <div class="space-y-3">
            <button @click="resendEmail()" 
                    :disabled="resending || timeRemaining > 3540"
                    class="w-full bg-blue-600 text-white py-3 px-4 rounded-lg font-medium hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition flex items-center justify-center">
              <span x-show="!resending">
                <span x-show="timeRemaining > 3540">Resend Available in <span x-text="Math.ceil((3600 - timeRemaining) / 60)"></span>m</span>
            ...
            <button @click="currentStep = 1" class="w-full text-gray-600 hover:text-gray-800 py-2 text-sm font-medium transition">
        ...
        <div x-show="currentStep === 3" x-transition class="bg-white rounded-2xl shadow-xl p-8">
          ...
          <form @submit.prevent="resetPassword()" class="space-y-6">
            ...
            <div>
              ...
              <div class="relative">
                <input :type="showPassword ? 'text' : 'password'"
                       ...
                       :class="passwordError ? 'border-red-300 ring-red-500' : ''"
              ...
              <div class="mt-3">
                <div class="flex justify-between text-xs mb-1">
                  ...
                  <span :class="getStrengthColor(passwordStrength)" x-text="getStrengthText(passwordStrength)"></span>
                </div>
            ...
            <div>
              ...
              <div class="relative">
                <input :type="showConfirmPassword ? 'text' : 'password'"
                       ...
                       class="block w-full pr-10 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition"
                       :class="confirmError ? 'border-red-300 ring-red-500' : ''"
                       autocomplete="new-password"
                       required>
                <button type="button" 
            ...
            <div class="bg-gray-50 rounded-lg p-4">
              ...
              <div class="space-y-2">
                <div class="flex items-center text-sm" :class="password.length >= 8 ? 'text-green-600' : 'text-gray-600'">
                  <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  At least 8 characters
                </div>
                <div class="flex items-center text-sm" :class="/[A-Z]/.test(password) ? 'text-green-600' : 'text-gray-600'">
                  <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                ...
                <div class="flex items-center text-sm" :class="/\d/.test(password) ? 'text-green-600' : 'text-gray-600'">
                  <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  One number
                </div>
                <div class="flex items-center text-sm" :class="/[^A-Za-z0-9]/.test(password) ? 'text-green-600' : 'text-gray-600'">
                  <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                  </svg>
            ...
            <button type="submit" 
                    :disabled="resetting || passwordStrength < 3"
