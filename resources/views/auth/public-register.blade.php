      ...
      <div class="max-w-md mx-auto">
          ...
          @if (collect($providers)->where('enabled', true)->isNotEmpty())
            ...
            <div class="relative mb-6">
              ...
              <div class="relative flex justify-center text-sm">
                <span class="px-3 bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400">Or register with
                  email</span>
              </div>
            </div>
          @endif
          ...
          <form method="POST" action="{{ route('register.public.store') }}" x-data="registrationForm()"
            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                <input type="tel" id="phone" name="phone" x-model="form.phone" @blur="touched.phone = true"
        ...
        <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
          <div class="text-gray-700 dark:text-gray-300">
            <div
              class="w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-2 bg-blue-100 dark:bg-blue-900/30">
          ...
          <div class="text-gray-700 dark:text-gray-300">
            <div
              class="w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-2 bg-emerald-100 dark:bg-emerald-900/30">
          ...
          <div class="text-gray-700 dark:text-gray-300">
            <div
              class="w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-2 bg-purple-100 dark:bg-purple-900/30">
