...
<head>
    ...
    <!-- SEO Meta -->
    <meta name="description" content="Verify your phone number for HD Tickets - Professional sports event ticket monitoring platform. Complete your account security setup.">
    ...
    <style>
        ...
        @media (prefers-color-scheme: dark) {
            ...
            .verification-bg { background: linear-gradient(135deg, #0f172a 0%, #0b1733 50%, #052e16 100%); }
        }
    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-8">
        ...
        <div class="w-full sm:max-w-md mt-1 px-6 py-8 form-card shadow-2xl overflow-hidden sm:rounded-2xl">
            ...
            <div class="text-center mb-8">
                <div class="mx-auto w-16 h-16 bg-primary-100 dark:bg-primary-900/20 rounded-full flex items-center justify-center mb-4">
                ...
                <p class="text-gray-600 dark:text-gray-300">
                    ...
                    <span class="font-medium text-gray-900 dark:text-gray-100">{{ substr($user->phone, 0, -4) . '****' }}</span>
                </p>
            </div>
            ...
            <!-- Verification Form -->
            <form method="POST" action="{{ route('phone.verify') }}" x-data="phoneVerification()" x-init="init()" @submit.prevent="submitCode">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <x-form.code-input 
                        ...
                        :alpine-model="'verificationCode'"
                        :alpine-events="['input' => 'onCodeInput()']"
                    />
                            ...
                            <div class="space-y-2">
                                ...
                                >
                                    ...
                                    <span x-show="resending" class="flex items-center">
                                        <svg class="animate-spin w-4 h-4 mr-1" fill="none" viewBox="0 0 24 24" aria-hidden="true">
                                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                        </svg>
                                        Sending...
