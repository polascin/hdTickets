...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Sports Ticket Monitor') }}</title>
    ...
    <body class="font-figtree bg-gradient-to-br from-blue-50 via-white to-purple-50 min-h-screen">
        ...
        <div class="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
            ...
            <div class="max-w-4xl mx-auto text-center">
                <!-- Logo/Icon -->
                <div class="mb-8">
                    <div class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl shadow-2xl mb-6 animate-pulse-slow">
