    ...
    <head>
        ...
        @if (file_exists(public_path('build/manifest.json')) || file_exists(public_path('hot')))
            ...
            <style>
                ...
                .non-critical-styles { display: none; }
            </style>
            <script>
            ...
            <style>
                ...
                .hd-login-bg {
                    background: linear-gradient(135deg, 
                        #1e40af 0%,     /* HD Professional Blue */
                        #3b82f6 35%,    /* Lighter blue */
                        #8b5cf6 70%,    /* Purple accent */
                        #1e40af 100%    /* Back to professional blue */
                    );
                    position: relative;
                    overflow: hidden;
                }
                ...
                .hd-login-card {
                    ...
                    padding: 48px 64px;
                    width: 100%;
                    max-width: 1024px; /* Increased to 1024px for proper desktop display */
                    position: relative;
                    z-index: 1;
