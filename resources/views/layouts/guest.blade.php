...
<head>
    ...
    <meta name="description" content="HD Tickets - Professional Sports Events Entry Tickets Monitoring, Scraping and Purchase System">
    ...
    @else
        <script>
            ...
            window.grecaptcha = {
                ...
                execute: function() { return Promise.resolve('development-token'); }
            };
        </script>
    @endif
...
<body class="h-full bg-gradient-to-br from-stadium-50 via-white to-stadium-100 font-sans antialiased">
    ...
    <div class="fixed inset-0 -z-10">
        <div class="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%239fa6b2" fill-opacity="0.05"%3E%3Ccircle cx="30" cy="30" r="1.5"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-40"></div>
    </div>
    ...
    <div class="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <div class="flex justify-center animate-fade-in">
                <picture>
                    <source srcset="{{ asset('assets/images/hdTicketsLogo.webp') }}" type="image/webp" width="80" height="80">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
            <div class="flex flex-col sm:flex-row justify-between items-center space-y-2 sm:space-y-0">
                ...
                <div class="flex items-center space-x-4 text-xs text-gray-400">
                    <a href="{{ route('legal.privacy-policy') }}" class="hover:text-gray-600 transition-colors">Privacy Policy</a>
                    <span>&bull;</span>
                    <a href="{{ route('legal.terms-of-service') }}" class="hover:text-gray-600 transition-colors">Terms of Service</a>
                    <span>&bull;</span>
