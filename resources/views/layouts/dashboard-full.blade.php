...
<head>
    ...
    <meta name="dashboard-api" content="{{ route('api.dashboard.data', ['type' => $__env->yieldContent('dashboard-type', 'customer')]) ?? '/api/dashboard/customer' }}">
    ...
    <link rel="preload" href="{{ asset('css/dashboard-common.css') }}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <link rel="preload" href="{{ asset('css/dashboard-loading.css') }}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="{{ asset('css/dashboard-common.css') }}"></noscript>
    <noscript><link rel="stylesheet" href="{{ asset('css/dashboard-loading.css') }}"></noscript>
