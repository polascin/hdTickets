...
<nav x-data="navigationData()" x-init="console.log('🔧 Navigation initialized:', $data)"
  class="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-header" :class="{ 'nav-scrolled': isScrolled }"
  role="banner" aria-label="Primary navigation" id="main-navigation">
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="flex">
        ...
        <div class="shrink-0 flex items-center">
          <a href="{{ route('dashboard') }}" class="flex items-center space-x-3"
            ...
            <x-application-logo size="default" class="transition-transform duration-200 hover:scale-105"
              aria-hidden="true" />
            <span class="hidden lg:block text-lg font-semibold text-gray-900 dark:text-gray-100">HD Tickets</span>
          </a>
        </div>

        <!-- Desktop Navigation Links -->
        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex items-center desktop-nav-links" role="navigation"
            ...
            @if (Auth::check() && Auth::user()->isAdmin())
              ...
              <div class="relative" @click.outside="adminDropdownOpen = false">
                <button @click="toggleAdminDropdown();"
                  ...
                  :aria-expanded="adminDropdownOpen" aria-haspopup="true" aria-label="Admin menu"
                ...
                <div x-show="adminDropdownOpen" x-cloak x-transition:enter="dropdown-enter"
                  ...
                  style="z-index: 99999 !important; position: absolute !important;" role="menu"
                  aria-orientation="vertical" aria-labelledby="admin-menu-button" data-dropdown="admin"
        ...
        <div class="hidden sm:flex sm:items-center sm:ms-4" x-data="themeManager()">
          <button type="button" @click="toggleTheme()"
            ...
            :title="getNextThemeLabel()" :aria-label="getNextThemeLabel()" :class="{ 'transitioning': isTransitioning }"
            id="theme-toggle">
        ...
        <div class="hidden sm:flex sm:items-center sm:ms-2">
          <div class="relative" @click.outside="profileDropdownOpen = false">
            ...
            <div x-show="profileDropdownOpen" x-cloak x-transition:enter="dropdown-enter"
              ...
              style="z-index: 99999 !important; position: absolute !important;" role="menu"
              aria-orientation="vertical" aria-labelledby="user-menu-button" data-dropdown="profile"
        ...
        <div class="-me-2 flex items-center sm:hidden">
          <button @click="toggleMobileMenu()" class="hd-mobile-hamburger"
            ...
            aria-label="Toggle mobile menu" aria-controls="mobile-menu" type="button" tabindex="0"
            role="button" :aria-describedby="mobileMenuOpen ? null : 'mobile-menu-desc'"
            ...
            <span class="sr-only" x-text="mobileMenuOpen ? 'Close navigation menu' : 'Open navigation menu'">Open
    ...
    <div :class="{ 'block': mobileMenuOpen, 'hidden': !mobileMenuOpen }"
      ...
      :class="{ 'open': mobileMenuOpen, 'closed': !mobileMenuOpen }" id="mobile-menu"
      :aria-hidden="(!mobileMenuOpen).toString()" role="navigation" aria-label="Mobile navigation menu"
      :aria-expanded="mobileMenuOpen.toString()" tabindex="-1" x-init="$watch('mobileMenuOpen', value => {
          if (value) {
              $nextTick(() => {
      ...
      <div class="px-4 sm:px-6 lg:px-8">
        <div class="pt-2 pb-3 space-y-1" role="menu" aria-label="Mobile menu items">
          ...
          <x-responsive-nav-link :href="route('dashboard')" :active="Request::routeIs('dashboard')" class="mobile-nav-link" role="menuitem"
            tabindex="0" aria-describedby="mobile-dashboard-desc">
