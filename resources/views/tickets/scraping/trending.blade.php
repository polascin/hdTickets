<x-unified-layout title="Trending Sports Event Tickets" subtitle="Discover the most popular and in-demand sports event tickets">
            ...
            <x-ui.card-content class="p-6">
                <div class="flex flex-col lg:flex-row gap-4 items-center">
                    ...
                    <div class="flex-1">
                        ...
                        <select id="limit-filter" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div class="flex-shrink-0">
                        <button id="apply-filters" class="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors">
                            Apply Filters
                        </button>
                    </div>
                </div>
                ...
                <x-ui.card-content class="text-center py-12">
                    <div class="text-gray-400 mb-4">
                        <svg class="w-16 h-16 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M9.172 16.172a4 4 0 015.656 0M9 12h6m-6-4h6m2 5.291A7.962 7.962 0 0112 15c-2.34 0-4.29-1.02-5.691-2.709M6.343 6.343l10.314 10.314"/>
                        </svg>
                    </div>
                    <h3 class="text-lg font-medium text-gray-900 mb-2">No Trending Tickets Found</h3>
                    <p class="text-gray-500 mb-6">
                        There are currently no trending sports event tickets available. Check back later or explore other categories.
                    </p>
        ...
        <x-ui.card>
            ...
            <x-ui.card-content>
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <a href="{{ route('tickets.alerts.index') }}" class="flex items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                        <div class="flex-shrink-0 w-10 h-10 bg-blue-600 rounded-lg flex items-center justify-center">
                            <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-5 5v-5z M13 13h5l-5 5v-5z"/>
                            </svg>
                        </div>
                        <div class="ml-4">
                    ...
                    <a href="{{ route('tickets.scraping.high-demand-sports') }}" class="flex items-center p-4 bg-red-50 rounded-lg hover:bg-red-100 transition-colors">
                    ...
                    <a href="{{ route('tickets.scraping.best-deals') }}" class="flex items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
