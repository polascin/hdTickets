<x-unified-layout title="Sports Tickets" subtitle="Browse and search for sports tickets across multiple platforms">
            ...
            @foreach ($activeFilters as $key => $value)
              @if ($value && $value !== '' && $value !== false)
                <span
                  ...
                  onkeydown="if(event.key==='Enter') removeFilter({{ json_encode($key) }})">
                  ...
                  <button type="button"
                    ...
                    onclick="removeFilter({{ json_encode($key) }})" aria-label="Remove {{ $key }} filter">
                    ×
                  </button>
                </span>
              @endif
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div>
            ...
            <select name="platform" id="platform"
              ...
              <!-- UK Platforms -->
              <option value="seetickets" {{ request('platform') == 'seetickets' ? 'selected' : '' }}>See Tickets UK
              </option>
              ...
              <option value="livenation" {{ request('platform') == 'livenation' ? 'selected' : '' }}>LiveNation UK
              </option>
              <!-- European Platforms -->
              <option value="eventim" {{ request('platform') == 'eventim' ? 'selected' : '' }}>Eventim (Germany)
              </option>
              <option value="ticketone" {{ request('platform') == 'ticketone' ? 'selected' : '' }}>TicketOne (Italy)
              </option>
              <option value="stargreen" {{ request('platform') == 'stargreen' ? 'selected' : '' }}>Stargreen (Germany)
              </option>
              <option value="ticketswap" {{ request('platform') == 'ticketswap' ? 'selected' : '' }}>TicketSwap
                (Resale)</option>
            </select>
          </div>
  ...
  <script>
    ...
    // Enhanced Modal for creating alert with full functionality
      ...
      modal.innerHTML = `
        <div class="bg-white rounded-lg shadow-xl p-8 max-w-lg w-full mx-4 transform transition-all">
          <div class="flex items-center justify-between mb-6">
            <h2 id="alert-modal-title" class="text-xl font-bold text-gray-900">Create Sports Ticket Alert</h2>
          ...
          <form id="create-alert-form" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
              <div>
                ...
                <select id="alert-platform" 
                  ...
                  <!-- UK Platforms -->
                  <option value="seetickets">See Tickets UK</option>
                  <option value="ticketek">Ticketek UK</option>
                  <option value="axs">AXS</option>
                  <option value="gigantic">Gigantic</option>
                  <option value="skiddle">Skiddle</option>
                  <option value="livenation">LiveNation UK</option>
                  <!-- European Platforms -->
                  <option value="eventim">Eventim (Germany)</option>
                  <option value="ticketone">TicketOne (Italy)</option>
                  <option value="stargreen">Stargreen (Germany)</option>
                  <option value="ticketswap">TicketSwap (Resale)</option>
            ...
            <div class="border-t pt-4">
              ...
              <div class="space-y-2">
                <label class="flex items-center">
                  <input type="checkbox" name="email_notifications" checked class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                  <span class="ml-2 text-sm text-gray-700">Email notifications</span>
                </label>
                <label class="flex items-center">
                  <input type="checkbox" name="sms_notifications" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
            ...
            <div class="flex justify-end space-x-3 pt-4">
              ...
              <button type="submit" id="submit-alert" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50">
                <span class="flex items-center">
                  <svg class="w-4 h-4 mr-2 hidden animate-spin" id="alert-spinner" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      modal.querySelector('#create-alert-form').addEventListener('submit', async (e) => {
        ...
        try {
          ...
          if (response.ok && result.success) {
            ...
            // Optionally refresh if on alerts page
