    ...
    <x-ui.card class="mb-6">
        ...
        <x-ui.card-content>
            <form id="filters-form" class="space-y-6">
                ...
                <div class="relative">
                    <x-ui.input name="keywords" label="Search Tickets"
                        placeholder="Search by event, team, venue, or keyword..." value="{{ request('keywords') }}"
                        variant="search" icon="search" iconPosition="left" class="pl-10" />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div>
                        ...
                        <select name="sort_by" id="sort_by" class="hd-input">
                            <option value="scraped_at"
                                {{ request('sort_by', 'scraped_at') == 'scraped_at' ? 'selected' : '' }}>Latest
                            </option>
                ...
                <div class="flex flex-wrap gap-6">
                    ...
                    <label class="flex items-center cursor-pointer group">
                        ...
                        <span
                            class="ml-2 hd-text-small group-hover:text-green-600 transition-colors flex items-center">
                    ...
                    <button type="button" id="advanced-filters-toggle"
                        ...
                        Advanced Filters
                        <svg class="w-3 h-3 ml-1 transition-transform" id="advanced-icon" fill="none"
                ...
                <div id="advanced-filters" class="hidden border-t pt-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="date" name="date_from" class="hd-input"
                    ...
                    <x-ui.card-content class="space-y-4 p-6">
                        ...
                        @if ($ticket->venue)
                            <div class="flex items-center text-gray-600">
                                ...
                                <span class="hd-text-small truncate"
                                    title="{{ $ticket->venue }}">{{ $ticket->venue }}</span>
                            </div>
                        @endif
                        ...
                        <div class="flex items-center justify-between pt-2 border-t border-gray-100">
                            <div class="flex items-center">
                                ...
                                <span
                                    class="hd-text-small text-gray-600 capitalize font-medium">{{ $ticket->platform }}</span>
            ...
            @forelse ($tickets as $ticket)
                <x-ui.card
                    ...
                    <x-ui.card-content class="p-6">
                        <div
                            class="flex flex-col lg:flex-row lg:items-center justify-between space-y-4 lg:space-y-0 lg:space-x-6">
                            <!-- Event Info -->
                            <div class="flex-1 min-w-0">
