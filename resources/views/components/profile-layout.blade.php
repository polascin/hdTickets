...
<div class="profile-layout min-h-screen bg-gray-50" x-data="{
    sidebarOpen: {{ $sidebarCollapsed ? 'false' : 'true' }},
    isMobile: window.innerWidth < 768,
    activeSection: '{{ $activeSection }}'
}" x-init="$watch('sidebarOpen', value => localStorage.setItem('profile-sidebar-collapsed', !value));
window.addEventListener('resize', () => {
  ...
  <!-- Main Layout Grid -->
  <div
    class="profile-grid {{ $mobileFriendly ? 'lg:grid' : 'grid' }} grid-cols-1 lg:grid-cols-4 xl:grid-cols-5 min-h-screen">

    <!-- Profile Sidebar -->
    @if ($showSidebar)
      <aside
        class="profile-sidebar bg-white shadow-lg lg:shadow-sm border-r border-gray-200 lg:col-span-1 xl:col-span-1
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
              <div class="profile-avatar-large">
                ...
                @else
                  <div
                    class="w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center border-4 border-white shadow-lg">
