...
<div x-data="{ mobileMenuOpen: false }" class="lg:hidden">
  ...
  <div x-show="mobileMenuOpen" x-transition:enter="transition-opacity ease-linear duration-300"
    ...
    class="fixed inset-0 z-20 bg-black bg-opacity-25 lg:hidden"></div>
  ...
  <div x-show="mobileMenuOpen" x-transition:enter="transition ease-in-out duration-300 transform"
    ...
    x-transition:leave-end="-translate-x-full" class="fixed inset-y-0 left-0 z-30 w-64 bg-white shadow-xl lg:hidden">
        ...
        <div class="flex items-center space-x-3 mb-3">
          ...
          <div class="w-10 h-10 rounded-full flex items-center justify-center overflow-hidden">
            @if ($profileDisplay['has_picture'])
              <img class="w-10 h-10 rounded-full object-cover" src="{{ $profileDisplay['picture_url'] }}"
