...
@foreach (array_merge(['https://fonts.bunny.net', 'https://cdn.jsdelivr.net', 'https://unpkg.com'], $dnsPrefetch) as $domain)
  <link rel="dns-prefetch" href="{{ $domain }}">
@endforeach

{{-- Preconnect for Critical External Resources --}}
@foreach (array_merge(['https://fonts.bunny.net', 'https://cdn.jsdelivr.net'], $preconnects) as $origin)
...
@foreach (array_merge(
  ...
  <link rel="preload" href="{{ $preload['href'] }}" as="{{ $preload['as'] }}"
    @if (isset($preload['type'])) type="{{ $preload['type'] }}" @endif
    @if (isset($preload['crossorigin'])) crossorigin="{{ $preload['crossorigin'] }}" @endif
    @if ($preload['as'] === 'style') onload="this.onload=null;this.rel='stylesheet'" @endif>
@endforeach
...
@if (file_exists(public_path('build/manifest.json')))
  @php
    ...
    $manifest = $manifestContent !== false ? json_decode($manifestContent, true) : [];
