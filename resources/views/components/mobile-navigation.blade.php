        ...
        <div class="mobile-nav-content">
            ...
            <div class="mobile-nav-brand">
                <a href="{{ route('dashboard') }}" 
                   ...
                   aria-label="HD Tickets - Go to dashboard">
                    <x-application-logo class="mobile-logo" aria-hidden="true" />
            ...
            <div class="mobile-nav-actions">
                ...
                @if($showNotifications && ($user?->isAdmin() || $user?->isAgent()))
                    <button @click="toggleNotifications()" 
                            class="mobile-action-btn mobile-notification-btn"
        ...
        <nav class="mobile-menu-nav" role="navigation">
            <ul class="mobile-nav-list" role="list">
                ...
                <li class="mobile-nav-item">
                    <a href="{{ route('dashboard') }}" 
                       class="mobile-nav-link {{ $currentRoute === 'dashboard' ? 'active' : '' }}"
                       @click="close()">
                ...
                <li class="mobile-nav-item">
                    <a href="{{ route('profile.show') }}" 
                       class="mobile-nav-link {{ Str::startsWith($currentRoute, 'profile') ? 'active' : '' }}"
                       @click="close()">
                        <svg class="mobile-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
