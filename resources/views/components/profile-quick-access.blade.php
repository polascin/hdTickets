...
@php
    ...
    $quickAccessSections = [
        ...
        [
            ...
            'badge' => !$user->two_factor_enabled ? 'action-needed' : null
        ],
        [
    ...
    <div class="px-4 py-3 border-b border-gray-200">
        ...
        <div class="flex items-center space-x-3 mb-3">
            <div class="relative">
                ...
                @else
                    <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center border-2 border-white shadow-md">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xs text-yellow-700">
                            {{ count($completion['missing_fields']) }} field{{ count($completion['missing_fields']) > 1 ? 's' : '' }} remaining
                        </p>
                    </div>
                </div>
            </div>
