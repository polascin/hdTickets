...
<style>
    ...
    .dashboard-customizer .widget-placeholder {
        @apply border-2 border-dashed border-gray-300 bg-gray-50 rounded-lg p-4 transition-all duration-200;
    }
    ...
    .dashboard-customizer .widget-customizing {
        @apply relative border-2 border-blue-500 shadow-lg;
    }
    
    .dashboard-customizer .widget-customizing::after {
        content: '';
        @apply absolute -top-1 -right-1 w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center text-white text-xs;
        content: '⚙️';
    }
    
    .dashboard-customizer .widget-dragging {
        @apply opacity-50 transform rotate-2 scale-95 transition-transform duration-200;
    }
    ...
    .dashboard-grid-4 { grid-template-columns: 1fr 1fr 1fr 1fr; }
    .dashboard-grid-mixed { grid-template-columns: 2fr 1fr; }
...
function dashboardCustomizer() {
    return {
        ...
        // Layout options
        layoutOptions: [
            { id: 'grid-1', name: '1 Column', columns: 1, gridClass: 'dashboard-grid-1' },
            { id: 'grid-2', name: '2 Columns', columns: 2, gridClass: 'dashboard-grid-2' },
            { id: 'grid-3', name: '3 Columns', columns: 3, gridClass: 'dashboard-grid-3' },
            { id: 'grid-4', name: '4 Columns', columns: 4, gridClass: 'dashboard-grid-4' },
            { id: 'grid-mixed', name: 'Mixed', columns: 2, gridClass: 'dashboard-grid-mixed' }
        ],
        ...
        showWidgetSettings(widget) {
            ...
            this.$dispatch('show-widget-settings', { widget });
        },
