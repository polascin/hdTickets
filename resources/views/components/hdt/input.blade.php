@php
  ...
  $inputAttributes = $attributes
    ->except(['variant', 'size', 'error', 'disabled', 'readonly', 'required', 'loading', 'label', 'hint', 'errorMessage', 'class'])
    ->merge([
      'id' => $id,
      'class' => $inputClasses,
    ...
    ->when($errorMessage && $error, fn($attr) => $attr->merge(['aria-describedby' => ($attr->get('aria-describedby') ? $attr->get('aria-describedby') . ' ' : '') . $id . '-error']))
