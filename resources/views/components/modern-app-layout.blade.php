...
<head>
    ...
    <!-- Icons -->
    <link rel="preload" href="https://cdnjs.cloudflare.com/ajax/libs/heroicons/2.0.18/24/outline/index.min.css" as="style">
...
<body class="h-full font-sans antialiased">
    <div id="app" class="hd-app-layout" x-data="appLayout()" x-init="init()">
        ...
        <aside 
            class="hd-sidebar"
            :class="{ 'hd-sidebar--collapsed': !sidebarOpen && isMobile }"
            x-show="sidebarOpen || !isMobile"
            ...
            <header class="hd-header">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <button 
                        ...
                        class="hd-button hd-button--ghost hd-button--sm"
