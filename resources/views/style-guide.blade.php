...
@push('styles')
<link rel="stylesheet" href="{{ asset('resources/css/variables/hd-variables.css') }}">
<link rel="stylesheet" href="{{ asset('resources/css/components/hd-buttons.css') }}">
<link rel="stylesheet" href="{{ asset('resources/css/components/hd-forms.css') }}">
<link rel="stylesheet" href="{{ asset('resources/css/components/hd-cards.css') }}">
<link rel="stylesheet" href="{{ asset('resources/css/components/hd-layout.css') }}">
<style>
...
.hd-component-showcase {
    background: var(--hd-bg-card);
    border: 1px solid var(--hd-border-primary);
    border-radius: var(--hd-radius-lg);
    padding: var(--hd-spacing-6);
    margin: var(--hd-spacing-4) 0;
}

.hd-code-block {
    background: var(--hd-slate-900);
    color: var(--hd-slate-100);
    border-radius: var(--hd-radius);
...
.hd-typography-demo h1,
.hd-typography-demo h2,
.hd-typography-demo h3,
.hd-typography-demo h4,
.hd-typography-demo h5,
.hd-typography-demo h6 {
    margin-bottom: var(--hd-spacing-2);
...
.hd-spacing-bar {
    ...
    padding: var(--hd-spacing-1);
    min-width: 40px;
}

.hd-navigation {
    position: sticky;
    top: var(--hd-spacing-4);
    background: var(--hd-bg-card);
    border: 1px solid var(--hd-border-primary);
    border-radius: var(--hd-radius-lg);
    padding: var(--hd-spacing-4);
...
.hd-navigation a {
    ...
    border-radius: var(--hd-radius);
    transition: var(--hd-transition-colors);
}
