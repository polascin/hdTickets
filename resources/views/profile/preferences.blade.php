...
<div class="min-h-screen bg-gray-50" x-data="preferencesManager()">
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div x-show="message" 
             x-text="message" 
             :class="messageType === 'success' ? 'bg-green-100 text-green-800 border-green-200' : 'bg-red-100 text-red-800 border-red-200'"
            ...
            <nav class="flex space-x-8" aria-label="Preferences">
                <button @click="activeTab = 'notifications'"
                    ...
                    <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-5-5V9.5a6.5 6.5 0 10-13 0V12l-5 5h5a3 3 0 003 3z" />
                    </svg>
                    Notifications
                </button>
                <button @click="activeTab = 'display'"
                        :class="activeTab === 'display' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700'"
                        class="whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm">
                    <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button @click="activeTab = 'timezone'"
                        :class="activeTab === 'timezone' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700'"
                        class="whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm">
                    <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button @click="activeTab = 'alerts'"
                        :class="activeTab === 'alerts' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700'"
                        class="whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm">
                    <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.99-.833-2.464 0L4.35 16.5c-.77.833.192 2.5 1.732 2.5z" />
                    </svg>
                    Alerts & Thresholds
                </button>
                <button @click="activeTab = 'sports'"
                        :class="activeTab === 'sports' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700'"
                        class="whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm">
                    <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            <input type="checkbox" 
                                                   ...
                                                   @change="updatePreference('email_notifications', $event.target.checked)"
                                                   class="sr-only peer">
                                ...
                                <div class="border border-gray-200 rounded-lg p-4">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            <input type="checkbox" 
                                                   x-model="preferences.push_notifications"
                                                   @change="updatePreference('push_notifications', $event.target.checked)"
                                                   class="sr-only peer">
                                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                                        </label>
                                    </div>
                                ...
                                <div class="border border-gray-200 rounded-lg p-4">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            <input type="checkbox" 
                                                   x-model="preferences.sms_notifications"
                                                   @change="updatePreference('sms_notifications', $event.target.checked)"
                                                   class="sr-only peer">
                                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                                        </label>
                                    </div>
                        ...
                        <div>
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center">
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" 
                                               x-model="preferences.quiet_hours_enabled"
                                               @change="updatePreference('quiet_hours_enabled', $event.target.checked)"
                                               class="sr-only peer">
                                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                                    </label>
                                ...
                                <div x-show="preferences.quiet_hours_enabled" class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="time" 
                                               x-model="preferences.quiet_hours_start"
                                    ...
                                    <div>
                                        ...
                                        <input type="time" 
                                               x-model="preferences.quiet_hours_end"
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                ...
                                <div class="relative">
                                    <input type="radio" 
                                           name="theme" 
                                           value="{{ $themeKey }}"
                                           x-model="preferences.theme"
                                           @change="updatePreference('theme', '{{ $themeKey }}')"
                                           class="sr-only peer"
                                           id="theme_{{ $themeKey }}">
                            ...
                            <div class="space-y-3">
                                <div class="flex items-center">
                                    <input type="radio" 
                                           name="density" 
                                           value="compact"
                                           x-model="preferences.display_density"
                        ...
                        <div>
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center justify-between">
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" 
                                               x-model="preferences.sidebar_collapsed"
                                               @change="updatePreference('sidebar_collapsed', $event.target.checked)"
                                               class="sr-only peer">
                                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                                    </label>
                                </div>
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" 
                                               x-model="preferences.show_tooltips"
                                               @change="updatePreference('show_tooltips', $event.target.checked)"
                                               class="sr-only peer">
                                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                                    </label>
                                </div>
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" 
                                               x-model="preferences.animation_enabled"
                                               @change="updatePreference('animation_enabled', $event.target.checked)"
                                               class="sr-only peer">
                                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                                    </label>
                                </div>
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" 
                                               x-model="preferences.high_contrast"
                                               @change="updatePreference('high_contrast', $event.target.checked)"
                                               class="sr-only peer">
                                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                                    </label>
                                </div>
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select x-model="preferences.user_timezone"
                        ...
                        <div>
                            ...
                            <select x-model="preferences.user_language"
                        ...
                        <div>
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center justify-between">
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" 
                                               x-model="preferences.availability_alerts"
                                               @change="updatePreference('availability_alerts', $event.target.checked)"
                                               class="sr-only peer">
                                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                                    </label>
                                </div>
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" 
                                               x-model="preferences.price_alerts"
                                               @change="updatePreference('price_alerts', $event.target.checked)"
                                               class="sr-only peer">
                                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                                    </label>
                                </div>
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" 
                                               x-model="preferences.high_demand_alerts"
                                               @change="updatePreference('high_demand_alerts', $event.target.checked)"
                                               class="sr-only peer">
                                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                                    </label>
                                </div>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="number" 
                                           x-model="preferences.price_drop_threshold"
                                           @input="updatePreference('price_drop_threshold', parseInt($event.target.value))"
                                           min="1" max="50" step="1"
                                           class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Dashboard Refresh Interval (seconds)</label>
                                    <input type="number" 
                                           x-model="preferences.dashboard_refresh_interval"
                        ...
                        <div>
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center justify-between">
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" 
                                               x-model="preferences.escalation_enabled"
                                               @change="updatePreference('escalation_enabled', $event.target.checked)"
                                               class="sr-only peer">
                                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                                    </label>
                                </div>
                                ...
                                <div x-show="preferences.escalation_enabled">
                                    ...
                                    <input type="number" 
                                           x-model="preferences.escalation_delay_minutes"
                        ...
                        <div>
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center justify-between">
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" 
                                               x-model="preferences.dashboard_auto_refresh"
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" 
                                               x-model="preferences.lazy_loading_enabled"
                                               @change="updatePreference('lazy_loading_enabled', $event.target.checked)"
                                               class="sr-only peer">
                                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                                    </label>
                                </div>
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" 
                                               x-model="preferences.data_compression"
                                               @change="updatePreference('data_compression', $event.target.checked)"
                                               class="sr-only peer">
                                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                                    </label>
                                </div>
                            ...
                            <div class="space-y-3">
                                <div class="flex items-center">
                                    <input type="radio" 
                                           name="bandwidth" 
                                           value="auto"
                                           x-model="preferences.bandwidth_optimization"
                        ...
                        <div>
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center justify-between">
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" 
                                               x-model="preferences.offline_mode"
                                               @change="updatePreference('offline_mode', $event.target.checked)"
                                               class="sr-only peer">
                                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                                    </label>
                                </div>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                <template x-for="(sport, key) in availableSports" :key="key">
                                    <label class="flex items-center p-3 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-300 transition-colors"
                                        ...
                                        <input type="checkbox" 
                                               :value="key"
                                               x-model="selectedSports"
                                               @change="updateSelectedSports()"
                                               class="sr-only">
                                        <div class="flex items-center">
                                        ...
                                        <div class="flex items-center space-x-4">
                                            <div class="flex-shrink-0">
                                                <div class="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center">
                                                    <span class="text-blue-600 font-semibold text-sm" x-text="team.sport_type.charAt(0).toUpperCase()"></span>
                                                </div>
                                            </div>
                                            <div>
                                                <h4 class="font-medium text-gray-900" x-text="team.team_city ? `${team.team_city} ${team.team_name}` : team.team_name"></h4>
                                                <p class="text-sm text-gray-500" x-text="`${team.sport_type} • ${team.league || 'Unknown League'}`"></p>
                                            </div>
                                        </div>
                                        <div class="flex items-center space-x-3">
                                            <!-- Priority Stars -->
                                            <div class="flex items-center">
                                                <template x-for="i in 5" :key="i">
                                                    <button @click="updateTeamPriority(team.id, i)"
                                    ...
                                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-500" x-text="`${venue.city}, ${venue.state_province || venue.country}`"></p>
                                            </div>
                                        </div>
                                        <div class="flex items-center space-x-3">
                                            <!-- Priority Stars -->
                                            <div class="flex items-center">
                                                <template x-for="i in 5" :key="i">
                                                    <button @click="updateVenuePriority(venue.id, i)"
                                                            class="w-4 h-4 focus:outline-none"
                                            ...
                                            <button @click="removeVenue(venue.id)"
                                                    class="text-red-500 hover:text-red-700">
                                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                                    <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"/>
                                                </svg>
                                ...
                                <template x-for="pref in pricePreferences" :key="pref.id">
                                    <div class="border border-gray-200 rounded-lg p-4">
                                        <div class="flex items-center justify-between mb-3">
                                            ...
                                            <div class="flex items-center space-x-2">
                                                <span x-show="pref.auto_purchase_enabled" class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                                    Auto-Purchase
                                                </span>
                                                <button @click="removePricePreference(pref.id)"
                                                        class="text-red-500 hover:text-red-700">
                                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                        <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"/>
                                                    </svg>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600">
                                            ...
                                            <div>
                                                ...
                                                <span x-text="pref.min_price ? `$${pref.min_price} - $${pref.max_price}` : `Up to $${pref.max_price}`"></span>
                                            </div>
                                            <div>
                                        ...
                                        <div class="mt-2 flex items-center space-x-4">
                                            ...
                                            <span class="text-xs text-gray-500" x-text="`${pref.alert_frequency} alerts • Drop threshold: ${pref.price_drop_threshold}%`"></span>
                                        </div>
                                    </div>
                                </template>
        ...
        <form @submit.prevent="addTeam()">
            <div class="space-y-4">
                <div>
                    ...
                    <select x-model="newTeam.sport_type" required class="w-full border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="text" 
                           x-model="newTeam.team_name" 
                           @input="searchTeams()"
                           placeholder="Start typing team name..."
                           required 
                           class="w-full border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                    <!-- Search results dropdown -->
                    <div x-show="teamSearchResults.length > 0" class="absolute z-10 w-full bg-white border border-gray-300 rounded-md shadow-lg mt-1">
                ...
                <div>
                    ...
                    <input type="text" x-model="newTeam.team_city" class="w-full border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                </div>
                
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">League</label>
                    <input type="text" x-model="newTeam.league" required class="w-full border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                </div>
                ...
                <div class="flex items-center space-x-4">
                    <label class="flex items-center">
                        <input type="checkbox" x-model="newTeam.email_alerts" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                        <span class="ml-2 text-sm text-gray-700">Email alerts</span>
                    </label>
                    <label class="flex items-center">
                        <input type="checkbox" x-model="newTeam.push_alerts" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
...
<div x-show="showAddVenueModal" 
     ...
     x-transition:leave-end="opacity-0"
     class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50" 
     @click.away="showAddVenueModal = false"
     x-data="venueModalManager()"
     style="display: none">
    <div class="bg-white rounded-lg p-6 w-full max-w-md">
        ...
        <form @submit.prevent="addVenue()">
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" 
                           x-model="newVenue.venue_name" 
                           @input="searchVenues()"
                           placeholder="Start typing venue name..."
                           required 
                           class="w-full border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                    <!-- Search results dropdown -->
                    <div x-show="venueSearchResults.length > 0" class="absolute z-10 w-full bg-white border border-gray-300 rounded-md shadow-lg mt-1">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" x-model="newVenue.city" required class="w-full border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">State/Province</label>
                        <input type="text" x-model="newVenue.state_province" class="w-full border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                    </div>
                </div>
                
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Country</label>
                    <input type="text" x-model="newVenue.country" required class="w-full border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                </div>
                
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Venue Type</label>
                    <select x-model="newVenue.venue_type" class="w-full border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="flex items-center space-x-4">
                    <label class="flex items-center">
                        <input type="checkbox" x-model="newVenue.email_alerts" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                        <span class="ml-2 text-sm text-gray-700">Email alerts</span>
                    </label>
                    <label class="flex items-center">
                        <input type="checkbox" x-model="newVenue.push_alerts" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                        <span class="ml-2 text-sm text-gray-700">Push alerts</span>
                    </label>
                </div>
            </div>
...
<div x-show="showAddPriceModal" 
     ...
     x-transition:leave-end="opacity-0"
     class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50" 
     @click.away="showAddPriceModal = false"
     x-data="priceModalManager()"
     style="display: none">
        ...
        <form @submit.prevent="addPricePreference()">
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" x-model="newPrice.preference_name" required placeholder="e.g., NBA Finals Under $200" class="w-full border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                </div>
                
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Sport Type</label>
                        <select x-model="newPrice.sport_type" class="w-full border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <select x-model="newPrice.event_category" class="w-full border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" x-model="newPrice.min_price" min="0" step="0.01" class="w-full border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Max Price ($)</label>
                        <input type="number" x-model="newPrice.max_price" min="0" step="0.01" required class="w-full border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" x-model="newPrice.preferred_quantity" min="1" max="20" value="2" class="w-full border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Alert Frequency</label>
                        <select x-model="newPrice.alert_frequency" class="w-full border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                            <option value="immediate">Immediate</option>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" x-model="newPrice.price_drop_threshold" min="1" max="50" value="10" class="w-full border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Preferred Section</label>
                        <input type="text" x-model="newPrice.preferred_section" placeholder="e.g., Lower Bowl, Upper Deck" class="w-full border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                    </div>
                </div>
                
                <div class="flex items-center space-x-4">
                    <label class="flex items-center">
                        <input type="checkbox" x-model="newPrice.email_alerts" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                        <span class="ml-2 text-sm text-gray-700">Email alerts</span>
                    </label>
                    <label class="flex items-center">
                        <input type="checkbox" x-model="newPrice.push_alerts" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                        <span class="ml-2 text-sm text-gray-700">Push alerts</span>
                    </label>
                    <label class="flex items-center">
                        <input type="checkbox" x-model="newPrice.auto_purchase_enabled" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
    ...
    return {
        ...
        updateTeamPriority(teamId, priority) {
            ...
            if (team) {
                ...
                this.updateTeamPreference(teamId, { priority: priority });
            }
        },
        ...
        updateVenuePriority(venueId, priority) {
            ...
            if (venue) {
                ...
                this.updateVenuePreference(venueId, { priority: priority });
            }
        },
        ...
        toggleTeamAlert(teamId, alertType) {
            ...
            if (team) {
                ...
                this.updateTeamPreference(teamId, { [fieldName]: team[fieldName] });
            }
        },
        ...
        toggleVenueAlert(venueId, alertType) {
            ...
            if (venue) {
                ...
                this.updateVenuePreference(venueId, { [fieldName]: venue[fieldName] });
            }
        },
        ...
        togglePriceAlert(priceId, alertType) {
            ...
            if (pref) {
                ...
                this.updatePricePreference(priceId, { [fieldName]: pref[fieldName] });
            }
        },
...
function teamModalManager() {
    return {
        ...
        searchTeams() {
            ...
            fetch(`{{ route("preferences.teams.search") }}?q=${encodeURIComponent(this.newTeam.team_name)}&sport=${this.newTeam.sport_type}`, {
                method: 'GET',
                headers: {
                    'Accept': 'application/json'
                }
...
<link rel="stylesheet" href="{{ asset('css/preferences.css') }}?v={{ time() }}">
