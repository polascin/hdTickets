      ...
      <div class="widget-grid">
          ...
          <div class="widget-header">
            <h3 class="widget-title">
              <svg class="widget-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M15 17h5l-5 5v-5zM4 17h5l-5 5v-5zM12 12l8-8a3 3 0 00-3-3l-8 8-8-8a3 3 0 00-3 3l8 8z"></path>
              </svg>
              Ticket Alerts
            </h3>
        ...
        <div class="widget-card" id="purchaseWidget">
          <div class="widget-header">
            <h3 class="widget-title">
              <svg class="widget-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-1.68 8.32M7 13h10m-10 0l-1.68 8.32M16 16h8"></path>
              </svg>
              Purchase Analytics
            </h3>
          ...
          <div class="stat-grid">
            ...
            <div class="stat-item">
              <div class="stat-value" id="avgTicketPrice">${{ number_format($purchaseData['average_ticket_price'], 2) }}
              </div>
        ...
        <div class="widget-card" id="watchlistWidget">
          ...
          <div class="stat-grid">
            ...
            <div class="stat-item">
              <div class="stat-value" id="avgPrice">${{ number_format($watchlistData['average_price'] ?? 0, 2) }}
              </div>
              <div class="stat-label">Avg Price</div>
            </div>
          </div>
              ...
              @forelse($watchlistData['price_trends'] as $eventName => $trend)
                <div class="recent-item">
                  <div>
                    ...
                    <div class="text-xs text-gray-600">${{ number_format($trend['first_price'], 2) }} →
                      ${{ number_format($trend['last_price'], 2) }}</div>
                  </div>
                  <div class="text-right">
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      function updateWidgets(data) {
        ...
        if (data.purchases) {
          ...
          document.getElementById('avgTicketPrice').textContent = '$' + parseFloat(data.purchases
            .average_ticket_price).toFixed(2);
