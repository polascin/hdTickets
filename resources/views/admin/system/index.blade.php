            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900" id="systemStatus">{{ $systemHealth['status'] ?? 'Unknown' }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4" id="servicesGrid">
                    ...
                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded">
                        <div class="flex items-center">
                            <div class="w-3 h-3 rounded-full {{ $service['status'] === 'running' ? 'bg-green-500' : 'bg-red-500' }} mr-3"></div>
...
<script>
let systemData = {
    health: @json($systemHealth ?? []),
    config: @json($systemConfig ?? []),
    logs: @json($logs ?? []),
