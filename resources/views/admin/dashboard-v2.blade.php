...
@section('page-header')
  <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3">
      ...
      <!-- Time Range Selector -->
      <select class="hdt-input hdt-input--sm" x-data x-model="$store.dashboard.timeRange"
        @change="$store.dashboard.updateData()">
          ...
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <div class="flex items-center mt-1">
                ...
                <span
                  class="ml-2 text-xs text-green-600 dark:text-green-400 bg-green-100 dark:bg-green-900/50 px-2 py-1 rounded-full">
                  99.9% uptime
                </span>
              </div>
            </div>
        ...
        <div class="hdt-card__body">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <div class="flex items-center mt-1">
                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100" x-text="systemStats.activeScrapers">
                </p>
                <span class="ml-2 text-xs"
                  :class="systemStats.scraperTrend === 'up' ? 'text-green-600 dark:text-green-400' :
            ...
            <div class="ml-4">
              ...
              <div class="flex items-center mt-1">
                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100"
                  x-text="systemStats.totalUsers.toLocaleString()"></p>
        ...
        <div class="hdt-card__body">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <div class="flex items-center mt-1">
                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-100">$<span
                    x-text="systemStats.revenueToday.toLocaleString()"></span></p>
                <span class="ml-2 text-xs"
                  :class="systemStats.revenueTrend === 'up' ? 'text-green-600 dark:text-green-400' :
                      'text-red-600 dark:text-red-400'">
                    ...
                    <tr>
                      <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                          ...
                          <div class="ml-3">
                            <div class="text-sm font-medium text-gray-900 dark:text-gray-100" x-text="platform.name">
                            </div>
                          </div>
                        </div>
                      </td>
                      ...
                      <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                          <div class="text-sm text-gray-900 dark:text-gray-100" x-text="platform.successRate + '%'">
                          </div>
                      ...
                      <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100"
                        x-text="platform.ticketsToday.toLocaleString()"></td>
                      <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400"
                        x-text="platform.lastUpdated"></td>
                    </tr>
                  </template>
                </tbody>
              </table>
        ...
        <div class="hdt-card__body">
          <div class="space-y-3">
            <template x-for="alert in systemAlerts" :key="alert.id">
              <div class="flex items-start justify-between p-3 rounded-lg" :class="getAlertClass(alert.severity)">
                <div class="flex items-start space-x-3">
                  <div class="flex-shrink-0 mt-0.5">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        :d="getAlertIcon(alert.severity)" />
                    </svg>
                  </div>
                  <div>
