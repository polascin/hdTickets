    ...
    <div class="row mb-4">
      <div class="col-lg-8">
        <div class="card">
          ...
          <div class="card-body">
            <div x-data="statsChart()" x-init="init()">
