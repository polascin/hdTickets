                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs" id="managementTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="platform-config-tab" data-bs-toggle="tab" data-bs-target="#platform-config" type="button" role="tab">
...
@section('scripts')
<script src="{{ asset('resources/js/components/platform-management.js') }}?v={{ time() }}"></script>
<script>
