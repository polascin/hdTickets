...
return new class() extends Migration {
    ...
    public function up(): void
    {
        ...
        if (! Schema::hasTable('user_notification_channels')) {
            Schema::create('user_notification_channels', function (Blueprint $table): void {
                $table->id();
        ...
        if (! Schema::hasTable('alert_escalation_rules')) {
            Schema::create('alert_escalation_rules', function (Blueprint $table): void {
                $table->id();
        ...
        if (! Schema::hasTable('alert_delivery_logs')) {
            Schema::create('alert_delivery_logs', function (Blueprint $table): void {
                $table->id();
        ...
        if (! Schema::hasTable('alert_learning_data')) {
            Schema::create('alert_learning_data', function (Blueprint $table): void {
                $table->id();
                $table->foreignId('user_id')->constrained()->onDelete('cascade');
        ...
        if (! Schema::hasTable('system_health_metrics')) {
            Schema::create('system_health_metrics', function (Blueprint $table): void {
                $table->id();
