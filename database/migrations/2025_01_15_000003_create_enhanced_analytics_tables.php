...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable('prediction_model_metrics')) {
            Schema::create('prediction_model_metrics', function (Blueprint $table) {
            $table->id();
        ...
        if (!Schema::hasTable('custom_analytics_queries')) {
            Schema::create('custom_analytics_queries', function (Blueprint $table) {
            $table->id();
        ...
        if (!Schema::hasTable('analytics_ab_tests')) {
            Schema::create('analytics_ab_tests', function (Blueprint $table) {
            $table->id();
        ...
        if (!Schema::hasTable('analytics_user_interactions')) {
            Schema::create('analytics_user_interactions', function (Blueprint $table) {
            $table->id();
            $table->foreignId('user_id')->constrained()->onDelete('cascade');
