                        ...
                        <div class="relative">
                            ...
                            <div id="adminDropdown" style="display: none;" 
                                ...
                                <a href="<?php echo e(route('admin.dashboard')); ?>" 
                                   class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition duration-150 ease-in-out <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-gray-50 text-blue-600' : ''); ?>">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="<?php echo e(route('admin.reports.index')); ?>" 
                                   class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition duration-150 ease-in-out <?php echo e(request()->routeIs('admin.reports.*') ? 'bg-gray-50 text-blue-600' : ''); ?>">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <?php if(Auth::user()->canManageUsers()): ?>
                                    <a href="<?php echo e(route('admin.users.index')); ?>" 
                                       class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition duration-150 ease-in-out <?php echo e(request()->routeIs('admin.users.*') ? 'bg-gray-50 text-blue-600' : ''); ?>">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php endif; ?>
            ...
            <?php if(Auth::user()->isAdmin()): ?>
                ...
                <div class="border-t border-gray-200 mt-3 pt-3">
                    <div class="px-4 py-2">
                        <div class="font-medium text-sm text-gray-800 uppercase tracking-wide"><?php echo e(__('Administration')); ?></div>
                    </div>
...
<?php endif; ?>
                    ...
                    <?php if (isset($component)) { $__componentOriginald69b52d99510f1e7cd3d80070b28ca18 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald69b52d99510f1e7cd3d80070b28ca18 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => route('admin.reports.index'),'active' => request()->routeIs('admin.reports.*')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('responsive-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
