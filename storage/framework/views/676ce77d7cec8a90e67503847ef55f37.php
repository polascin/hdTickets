...
<div class="container mx-auto px-4">
    <div class="flex justify-between items-center mb-4">
        <h1>Sports Ticket Monitor <span class="badge bg-primary ms-2" id="total-tickets"><?php echo e($tickets->total() ?? 0); ?></span></h1>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.platform-select','data' => ['name' => 'platform','value' => request('platform'),'class' => 'form-select']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'platform','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request('platform')),'class' => 'form-select']); ?>
...
<?php endif; ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select" name="availability">
                            ...
                            <option value="1" <?php echo e(request('availability') == '1' ? 'selected' : ''); ?>>Available Only</option>
                            <option value="0" <?php echo e(request('availability') == '0' ? 'selected' : ''); ?>>Sold Out</option>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="high_demand" value="1" 
                                   <?php echo e(request('high_demand') ? 'checked' : ''); ?> id="high_demand">
...
<script src="<?php echo e(asset('js/modules/LazyTicketLoader.js')); ?>"></script>
<script>
