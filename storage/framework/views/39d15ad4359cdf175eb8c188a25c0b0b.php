...
<?php $__env->startSection('title', 'Ticket API Integration'); ?>
<?php $__env->startSection('description', 'Integrate with external ticket platforms - Ticketmaster, StubHub, and more'); ?>
...
<div class="py-6 space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <?php $__currentLoopData = $availablePlatforms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $platform): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="p-6 relative">
                ...
                <div class="flex items-center justify-between relative z-10">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <div class="text-lg font-bold text-gray-900 capitalize"><?php echo e($platform); ?></div>
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <label class="flex items-center">
                            <input type="checkbox" name="platforms[]" value="<?php echo e($platform); ?>" checked
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                            <span class="ml-2 text-sm text-gray-700 capitalize"><?php echo e($platform); ?></span>
                        </label>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    searchForm.addEventListener('submit', function(e) {
        ...
        // Determine endpoint
        const endpoint = action === 'import' ? '<?php echo e(route("ticket-api.import")); ?>' : '<?php echo e(route("ticket-api.search")); ?>';
    ...
    window.testAllConnections = function() {
        fetch('<?php echo e(route("ticket-api.test")); ?>', {
            method: 'GET',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                'Accept': 'application/json',
...
<?php echo $__env->make('layouts.modern', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\polas\OneDrive\www\hdtickets\resources\views/ticket-api/index.blade.php ENDPATH**/ ?>