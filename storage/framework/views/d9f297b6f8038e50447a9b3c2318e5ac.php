    ...
    <div class="p-6">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <?php $__currentLoopData = $actions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(!isset($action['permission']) || (Auth::user() && Auth::user()->{$action['permission']}())): ?>
                    <?php
                    ...
                    <a href="<?php echo e(route($action['route'])); ?>" 
                       class="group block p-4 bg-gradient-to-br <?php echo e($colorClasses); ?> rounded-lg shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 text-white">
...
<?php /**PATH C:\Users\polas\OneDrive\www\hdtickets\resources\views\components\dashboard\quick-actions.blade.php ENDPATH**/ ?>