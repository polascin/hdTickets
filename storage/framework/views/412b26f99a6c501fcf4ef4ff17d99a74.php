...
<div class="flex justify-between items-center">
    <div>
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('My Ticket Alerts')); ?>
    ...
    <div class="flex items-center space-x-4">
        ...
        <div class="text-sm text-gray-600">
            <?php echo e($activeAlerts); ?> Active • <?php echo e($totalMatches); ?> Total Matches
        </div>
        <!-- Create Alert Button -->
            ...
            <div class="dashboard-card">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <div class="text-2xl font-bold text-gray-900"><?php echo e($alerts->where('is_active', true)->count()); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="dashboard-card">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <div class="text-2xl font-bold text-gray-900"><?php echo e($alerts->count()); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="dashboard-card">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <div class="text-2xl font-bold text-gray-900"><?php echo e($alerts->sum('matches_found')); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="dashboard-card">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <div class="text-2xl font-bold text-gray-900"><?php echo e($alerts->where('updated_at', '>=', now()->subDay())->sum('matches_found')); ?></div>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="flex items-start justify-between">
                                    <div class="flex-1">
                                        <div class="flex items-center mb-2">
                                            <h4 class="text-lg font-semibold text-gray-900"><?php echo e($alert->name); ?></h4>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                                            <div>
                                                ...
                                                <div class="text-sm text-gray-900"><?php echo e($alert->keywords); ?></div>
                                            </div>
                                            <div>
                                                <div class="text-sm font-medium text-gray-500">Platform</div>
                                                <div class="text-sm text-gray-900">
                                                    <?php if($alert->platform): ?>
                                                        <?php echo e(config('platforms.display_order.' . $alert->platform . '.display_name', ucfirst($alert->platform))); ?>
                                            ...
                                            <div>
                                                ...
                                                <div class="text-sm text-gray-900">
                                                    <?php echo e($alert->max_price ? $alert->currency . ' ' . number_format($alert->max_price, 2) : 'No limit'); ?>

                                                </div>
                                            </div>
                                            <div>
                                                <div class="text-sm font-medium text-gray-500">Matches Found</div>
                                                <div class="text-sm font-bold text-blue-600"><?php echo e($alert->matches_found ?? 0); ?></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex items-center text-sm text-gray-500">
                                            ...
                                            Created <?php echo e($alert->created_at->diffForHumans()); ?>

                                            <?php if($alert->last_checked_at): ?>
                                                • Last checked <?php echo e($alert->last_checked_at->diffForHumans()); ?>
                                    ...
                                    <div class="flex items-center space-x-2 ml-4">
                                        <button onclick="editAlert(<?php echo e($alert->id); ?>)" class="text-blue-600 hover:text-blue-800 font-medium text-sm">
                                            Edit
                                        </button>
                                        <button onclick="toggleAlert(<?php echo e($alert->id); ?>, <?php echo e($alert->is_active ? 'false' : 'true'); ?>)" 
                                                class="text-yellow-600 hover:text-yellow-800 font-medium text-sm">
                                            <?php echo e($alert->is_active ? 'Pause' : 'Activate'); ?>

                                        </button>
                                        <button onclick="deleteAlert(<?php echo e($alert->id); ?>)" class="text-red-600 hover:text-red-800 font-medium text-sm">
                                            Delete
                                        </button>
                                    </div>
                                </div>
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <?php if (isset($component)) { $__componentOriginal73e3eb4bf3db1578a87c61f5f8921d7f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73e3eb4bf3db1578a87c61f5f8921d7f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.platform-select','data' => ['name' => 'platform','id' => 'platform','class' => 'mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('platform-select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'platform','id' => 'platform','class' => 'mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal73e3eb4bf3db1578a87c61f5f8921d7f)): ?>
<?php $attributes = $__attributesOriginal73e3eb4bf3db1578a87c61f5f8921d7f; ?>
<?php unset($__attributesOriginal73e3eb4bf3db1578a87c61f5f8921d7f); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal73e3eb4bf3db1578a87c61f5f8921d7f)): ?>
<?php $component = $__componentOriginal73e3eb4bf3db1578a87c61f5f8921d7f; ?>
<?php unset($__componentOriginal73e3eb4bf3db1578a87c61f5f8921d7f); ?>
<?php endif; ?>
                        </div>
...
function openModal(title = 'Create Alert', alert = null) {
    ...
    if (alert) {
        // Edit mode
        document.getElementById('alertForm').action = `<?php echo e(url('tickets/alerts')); ?>/${alert.id}`;
        ...
        // Create mode
        document.getElementById('alertForm').action = '<?php echo e(route("tickets.alerts.create")); ?>';
...
function toggleAlert(alertId, isActive) {
    fetch(`<?php echo e(url('tickets/alerts')); ?>/${alertId}`, {
        method: 'PATCH',
        headers: {
...
document.getElementById('checkAlertsBtn').addEventListener('click', function() {
    ...
    fetch('<?php echo e(route("tickets.alerts.check")); ?>', {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
        }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\polas\OneDrive\www\hdtickets\resources\views/tickets/alerts/index.blade.php ENDPATH**/ ?>