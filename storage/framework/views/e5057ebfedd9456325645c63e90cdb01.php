            ...
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <h2 class="font-bold text-xl md:text-2xl text-gray-800 leading-tight">
                        <?php echo e(__('Advanced Scraping Management')); ?>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div class="bg-white rounded-lg p-4 shadow-md border border-red-200">
                            ...
                            <p class="text-2xl font-bold text-gray-900 mb-1"><?php echo e($advancedStats['anti_detection_operations'] ?? 0); ?></p>
                            <p class="text-xs text-gray-500"><?php echo e(number_format((($advancedStats['anti_detection_operations'] ?? 0) / max($stats['total_operations'] ?? 1, 1)) * 100, 1)); ?>% of total</p>
                        </div>
                        ...
                        <div class="bg-white rounded-lg p-4 shadow-md border border-orange-200">
                            ...
                            <p class="text-2xl font-bold text-gray-900 mb-1"><?php echo e($advancedStats['high_demand_sessions'] ?? 0); ?></p>
                            <p class="text-xs text-gray-500">Avg: <?php echo e($advancedStats['high_demand_avg_time'] ?? 0); ?>ms</p>
                        </div>
                        ...
                        <div class="bg-white rounded-lg p-4 shadow-md border border-green-200">
                            ...
                            <p class="text-2xl font-bold text-gray-900 mb-1"><?php echo e($advancedStats['protected_success_rate'] ?? 0); ?>%</p>
                            <p class="text-xs text-gray-500">vs <?php echo e($stats['success_rate'] ?? 0); ?>% standard</p>
                        </div>
                        ...
                        <div class="bg-white rounded-lg p-4 shadow-md border border-yellow-200">
                            ...
                            <p class="text-2xl font-bold text-gray-900 mb-1"><?php echo e($advancedStats['threats_detected'] ?? 0); ?></p>
                            <p class="text-xs text-gray-500"><?php echo e($advancedStats['threats_blocked'] ?? 0); ?> blocked</p>
                        </div>
                    </div>
                            ...
                            <div class="space-y-2">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="flex items-center text-sm text-blue-600">
                                        ...
                                        <?php echo e($advancedStats['priority_queue_size'] ?? 0); ?> items
                                    </span>
                                </div>
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="flex items-center text-sm text-blue-600">
                                        <div class="w-2 h-2 bg-blue-500 rounded-full mr-2"></div>
                                        <?php echo e($advancedStats['dedicated_pools'] ?? 0); ?> active
                                    </span>
                                </div>
                                <div class="flex justify-between items-center">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="flex items-center text-sm text-purple-600">
                                        ...
                                        <?php echo e($advancedStats['cache_hit_rate'] ?? 0); ?>%
                                    </span>
                                </div>
                            </div>
                        </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\polas\OneDrive\www\hdtickets\resources\views/admin/scraping/index.blade.php ENDPATH**/ ?>