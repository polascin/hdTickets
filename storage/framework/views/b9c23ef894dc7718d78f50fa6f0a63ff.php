            ...
            <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col sm:flex-row justify-between items-center text-sm text-gray-500 text-center sm:text-left">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:space-x-4">
                        <div>© <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?>. All rights reserved! Developed by <a href="mailto:walter.csoelle@gmail.com" class="font-medium text-blue-600 hover:text-blue-800 underline">Walter Csoelle</a>.</div>
                    </div>
