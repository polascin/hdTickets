                    ...
                    <div class="p-6 relative">
                        ...
                        <div class="flex items-center relative z-10">
                            ...
                            <div class="ml-4 flex-1">
                                ...
                                <div class="text-3xl font-bold text-gray-900 mb-1" data-counter="<?php echo e($scrapedTickets ?? 0); ?>">0</div>
                    ...
                    <div class="p-6 relative">
                        ...
                        <div class="flex items-center relative z-10">
                            ...
                            <div class="ml-4 flex-1">
                                ...
                                <div class="text-3xl font-bold text-gray-900 mb-1" data-counter="<?php echo e($activeMonitors ?? 0); ?>">0</div>
                    ...
                    <div class="p-6 relative">
                        ...
                        <div class="flex items-center relative z-10">
                            ...
                            <div class="ml-4 flex-1">
                                ...
                                <div class="text-3xl font-bold text-gray-900 mb-1" data-counter="<?php echo e($premiumTickets ?? 0); ?>">0</div>
                    ...
                    <div class="p-6 relative">
                        ...
                        <div class="flex items-center relative z-10">
                            ...
                            <div class="ml-4 flex-1">
                                ...
                                <div class="text-3xl font-bold text-gray-900 mb-1" data-counter="<?php echo e($totalUsers ?? 0); ?>">0</div>
                                <div class="text-xs text-green-500 font-medium flex items-center">
                                    <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-gradient-to-br from-blue-50 to-indigo-100 border-2 border-blue-200 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="text-right">
                            <div class="text-2xl font-bold text-blue-900"><?php echo e($totalUsers); ?></div>
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-4">
                        <div class="bg-white/60 backdrop-blur-sm rounded-lg p-3 text-center">
                            <div class="text-lg font-bold text-green-600"><?php echo e($totalAgents); ?></div>
                            <div class="text-xs text-gray-600">Agents</div>
                        </div>
                        <div class="bg-white/60 backdrop-blur-sm rounded-lg p-3 text-center">
                            <div class="text-lg font-bold text-purple-600"><?php echo e($totalCustomers); ?></div>
