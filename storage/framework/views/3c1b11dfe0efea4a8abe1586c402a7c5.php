...
<head>
    ...
    <title>User Management - <?php echo e(config('app.name')); ?></title>
...
<body class="bg-gray-100">
    <div class="min-h-screen">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    ...
                    <div class="flex items-center space-x-4">
                        <a href="<?php echo e(route('dashboard')); ?>" class="text-gray-600 hover:text-gray-900">Dashboard</a>
                        <a href="<?php echo e(route('admin.users.index')); ?>" class="text-blue-600 font-medium">Users</a>
        ...
        <div class="py-8 px-4 sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto">
                <div class="mb-6 flex justify-between items-center">
                    ...
                    <div class="flex space-x-2">
                        ...
                        <a href="<?php echo e(route('admin.users.create')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg shadow-sm transition-colors duration-200">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                            </svg>
                            Create User
            ...
            <div class="mb-6">
                <form method="GET" action="<?php echo e(route('admin.users.index')); ?>" class="bg-white rounded-xl shadow-lg border border-gray-100">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="flex items-center space-x-2">
                                <?php if(request()->hasAny(['search', 'role', 'status', 'date_from', 'date_to'])): ?>
                                    <a href="<?php echo e(route('admin.users.index')); ?>" class="inline-flex items-center px-3 py-1 bg-gray-100 hover:bg-gray-200 text-gray-700 text-sm font-medium rounded-md transition-colors duration-200">
                        ...
                        <div class="relative mb-4">
                            ...
                            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search by name, email, username, or phone..." class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 sm:text-sm shadow-sm transition duration-200">
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 search-mobile">
                                ...
                                <div>
                                    ...
                                    <select name="role" id="role" class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        <option value="all" <?php echo e(request('role', 'all') === 'all' ? 'selected' : ''); ?>>All Roles</option>
                                ...
                                <div>
                                    ...
                                    <select name="status" id="status" class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        ...
                                        <option value="verified" <?php echo e(request('status') === 'verified' ? 'selected' : ''); ?>>Email Verified</option>
                                        <option value="unverified" <?php echo e(request('status') === 'unverified' ? 'selected' : ''); ?>>Email Unverified</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="date" name="date_from" id="date_from" value="<?php echo e(request('date_from')); ?>" class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                </div>
                                
                                <!-- Date To -->
                                <div>
                                    <label for="date_to" class="block text-sm font-medium text-gray-700 mb-1">Created To</label>
                                    <input type="date" name="date_to" id="date_to" value="<?php echo e(request('date_to')); ?>" class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                </div>
                            </div>
                ...
                <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-800 flex items-center">
                        ...
                        <span class="ml-2 px-2 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full">
                            <?php echo e($users->total()); ?> <?php echo e(Str::plural('user', $users->total())); ?>
...
<tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                    <button onclick="sortTable('name')" class="flex items-center space-x-1 hover:text-blue-600 transition-colors duration-200">
                                        <span>Full Name</span>
                                        <svg class="w-4 h-4 <?php echo e(request('sort_by') === 'name' ? 'text-blue-600' : 'text-gray-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <?php if(request('sort_by') === 'name' && request('sort_order') === 'asc'): ?>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 11l5-5m0 0l5 5m-5-5v12"></path>
                                            <?php elseif(request('sort_by') === 'name' && request('sort_order') === 'desc'): ?>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                    <button onclick="sortTable('email')" class="flex items-center space-x-1 hover:text-blue-600 transition-colors duration-200">
                                        <span>Email</span>
                                        <svg class="w-4 h-4 <?php echo e(request('sort_by') === 'email' ? 'text-blue-600' : 'text-gray-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <?php if(request('sort_by') === 'email' && request('sort_order') === 'asc'): ?>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 11l5-5m0 0l5 5m-5-5v12"></path>
                                            <?php elseif(request('sort_by') === 'email' && request('sort_order') === 'desc'): ?>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 13l-5 5m0 0l-5-5m5 5V6"></path>
                                            <?php else: ?>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l4-4 4 4m0 6l-4 4-4-4"></path>
                                            <?php endif; ?>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                    <button onclick="sortTable('role')" class="flex items-center space-x-1 hover:text-blue-600 transition-colors duration-200">
                                        <span>Role</span>
                                        <svg class="w-4 h-4 <?php echo e(request('sort_by') === 'role' ? 'text-blue-600' : 'text-gray-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <?php if(request('sort_by') === 'role' && request('sort_order') === 'asc'): ?>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 11l5-5m0 0l5 5m-5-5v12"></path>
                                            <?php elseif(request('sort_by') === 'role' && request('sort_order') === 'desc'): ?>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 13l-5 5m0 0l-5-5m5 5V6"></path>
                                            <?php else: ?>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l4-4 4 4m0 6l-4 4-4-4"></path>
                                            <?php endif; ?>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                    <button onclick="sortTable('is_active')" class="flex items-center space-x-1 hover:text-blue-600 transition-colors duration-200">
                                        <span>Status</span>
                                        <svg class="w-4 h-4 <?php echo e(request('sort_by') === 'is_active' ? 'text-blue-600' : 'text-gray-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <?php if(request('sort_by') === 'is_active' && request('sort_order') === 'asc'): ?>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 11l5-5m0 0l5 5m-5-5v12"></path>
                                            <?php elseif(request('sort_by') === 'is_active' && request('sort_order') === 'desc'): ?>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 13l-5 5m0 0l-5-5m5 5V6"></path>
                                            <?php else: ?>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l4-4 4 4m0 6l-4 4-4-4"></path>
                                            <?php endif; ?>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                    <button onclick="sortTable('created_at')" class="flex items-center space-x-1 hover:text-blue-600 transition-colors duration-200">
                                        <span>Joined</span>
                                        <svg class="w-4 h-4 <?php echo e(request('sort_by') === 'created_at' ? 'text-blue-600' : 'text-gray-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <?php if(request('sort_by') === 'created_at' && request('sort_order') === 'asc'): ?>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 11l5-5m0 0l5 5m-5-5v12"></path>
                                            <?php elseif(request('sort_by') === 'created_at' && request('sort_order') === 'desc'): ?>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 13l-5 5m0 0l-5-5m5 5V6"></path>
                                            <?php else: ?>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l4-4 4 4m0 6l-4 4-4-4"></path>
                                            <?php endif; ?>
...
<td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-semibold text-gray-900 cursor-pointer hover:bg-gray-100 rounded px-2 py-1" onclick="enableInlineEditing('name', <?php echo e($user->id); ?>, '<?php echo e($user->name); ?>')"><?php echo e($user->full_name); ?></div>
                                            <div class="text-xs text-gray-500">ID: <?php echo e($user->id); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900 cursor-pointer hover:bg-gray-100 rounded px-2 py-1" onclick="enableInlineEditing('email', <?php echo e($user->id); ?>, '<?php echo e($user->email); ?>')"><?php echo e($user->email); ?></div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex flex-wrap items-center gap-1 actions-mobile">
                                        <a href="<?php echo e(route('admin.users.show', $user)); ?>" class="inline-flex items-center px-2 py-1 bg-blue-100 hover:bg-blue-200 text-blue-700 text-xs font-medium rounded-md transition-colors duration-200">
                                        ...
                                        <a href="<?php echo e(route('admin.users.edit', $user)); ?>" class="inline-flex items-center px-2 py-1 bg-indigo-100 hover:bg-indigo-200 text-indigo-700 text-xs font-medium rounded-md transition-colors duration-200">
                                            <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <?php if($user->id !== auth()->id()): ?>
                                            <button type="button" onclick="impersonateUser(<?php echo e($user->id); ?>)" class="inline-flex items-center px-2 py-1 bg-purple-100 hover:bg-purple-200 text-purple-700 text-xs font-medium rounded-md transition-colors duration-200">
                                                <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <?php if(!$user->email_verified_at): ?>
                                                <form method="POST" action="<?php echo e(route('admin.users.send-verification', $user)); ?>" class="inline">
                                                    <?php echo csrf_field(); ?>
                                            ...
                                            <form method="POST" action="<?php echo e(route('admin.users.destroy', $user)); ?>" class="inline" onsubmit="return confirm('Are you sure you want to delete this user? This action cannot be undone.')">
                                                <?php echo csrf_field(); ?>
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <button onclick="window.location.href='<?php echo e(route('admin.users.create')); ?>'" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-md transition-colors duration-200">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                                            </svg>
                                            Add First User
...
<script>
        ...
        function sortTable(field) {
            const currentSortBy = '<?php echo e(request("sort_by")); ?>';
            const currentSortOrder = '<?php echo e(request("sort_order")); ?>';
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const hasActiveFilters = '<?php echo e(request()->hasAny(["role", "status", "date_from", "date_to"]) ? "true" : "false"); ?>' === 'true';
        ...
        function impersonateUser(userId) {
            if (confirm('Are you sure you want to impersonate this user?')) {
                const form = document.createElement('form');
                form.method = 'POST';
                form.action = `<?php echo e(route('admin.users.impersonate', ':userId')); ?>`.replace(':userId', userId);
        ...
        function saveInlineEdit(field, userId, newValue, cell) {
            fetch(`<?php echo e(route('admin.users.inline-update', ':userId')); ?>`.replace(':userId', userId), {
                method: 'PATCH',
                headers: {
    ...
    <div id="quickCreateUserModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white modal-mobile">
            <div class="mt-3">
                ...
                <form method="POST" action="<?php echo e(route('admin.users.store')); ?>" id="quickCreateForm">
                    <?php echo csrf_field(); ?>
                    <div class="mb-4">
...
<?php /**PATH C:\Users\polas\OneDrive\www\hdtickets\resources\views/admin/users/index.blade.php ENDPATH**/ ?>