...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.platform-select','data' => ['name' => 'platform','value' => request('platform'),'class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'platform','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request('platform')),'class' => 'block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm']); ?>
