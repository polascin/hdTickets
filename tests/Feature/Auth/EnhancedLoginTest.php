...
class EnhancedLoginTest extends TestCase
{
    ...
    /** @test */
    public function it_displays_the_enhanced_login_page_when_configured()
    {
    ...
    /** @test */
    public function it_can_successfully_login_with_valid_credentials()
    {
    ...
    /** @test */
    public function it_rejects_login_for_locked_account()
    {
    ...
    /** @test */
    public function it_rejects_login_for_inactive_account()
    {
    ...
    /** @test */
    public function it_rejects_login_for_scraper_accounts()
    {
    ...
    /** @test */
    public function it_handles_two_factor_authentication_redirect()
    {
        // Enable 2FA for user
    ...
    /** @test */
    public function it_can_complete_two_factor_authentication()
    {
        // Setup 2FA
        $twoFactorService = app(TwoFactorAuthService::class);
        $secret = $twoFactorService->generateSecretKey();
    ...
    /** @test */
    public function it_handles_invalid_two_factor_codes()
    {
        // Setup 2FA
        $twoFactorService = app(TwoFactorAuthService::class);
        $secret = $twoFactorService->generateSecretKey();
    ...
    /** @test */
    public function it_can_use_recovery_codes_for_two_factor()
    {
        ...
        $this->testUser->refresh();
        $remainingCodes = json_decode(decrypt($this->testUser->two_factor_recovery_codes), true);
        $this->assertNotContains('ABCD-1234', $remainingCodes);
        $this->assertContains('EFGH-5678', $remainingCodes);
    }

    /** @test */
    public function it_can_send_sms_backup_codes()
    {
    ...
    /** @test */
    public function it_can_send_email_backup_codes()
    {
        // Setup 2FA
        $this->testUser->update([
            'two_factor_secret' => encrypt('test-secret'),
    ...
    /** @test */
    public function it_validates_required_login_fields()
    {
        $response = $this->post('/login', []);
    ...
    /** @test */
    public function it_handles_honeypot_field()
    {
        $response = $this->post('/login', [
            'email' => $this->testUser->email,
            'password' => $this->testPassword,
    ...
    /** @test */
    public function it_handles_nonexistent_email_check()
    {
        $response = $this->postJson('/login/check-email', [
    ...
    /** @test */
    public function it_rate_limits_email_checks()
    {
    ...
    /** @test */
    public function it_processes_device_fingerprinting()
    {
    ...
    /** @test */
    public function it_remembers_user_when_requested()
    {
        $response = $this->post('/login', [
            'email' => $this->testUser->email,
            'password' => $this->testPassword,
    ...
    /** @test */
    public function it_logs_successful_login_activity()
    {
        $response = $this->post('/login', [
            'email' => $this->testUser->email,
            'password' => $this->testPassword,
    ...
    /** @test */
    public function it_displays_two_factor_challenge_page()
    {
    ...
    /** @test */
    public function it_redirects_to_login_if_no_2fa_session()
    {
        $response = $this->get('/2fa/challenge');
