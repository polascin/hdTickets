...
class ShowHighDemandSports extends Command
{
    ...
    public function handle()
    {
        ...
        $filteredEvents = array_slice($filteredEvents, 0, $limit);
        ...
        $this->table([
            ...
            ['High Demand Events', count(array_filter($filteredEvents, fn($e) => in_array($e['demand_level'], ['HIGH', 'VERY HIGH', 'EXTREMELY HIGH', 'MAXIMUM'])))],
