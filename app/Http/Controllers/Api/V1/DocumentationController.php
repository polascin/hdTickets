...
class DocumentationController extends Controller
{
    ...
    private function getApiRequestStats($user, $period): array { return []; }
    private function getEndpointUsageStats($user, $period): array { return []; }
    private function getErrorRateStats($user, $period): array { return []; }
    private function getPerformanceStats($user, $period): array { return []; }
    private function getCostAnalysis($user, $period): array { return []; }
}