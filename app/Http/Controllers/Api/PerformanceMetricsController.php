...
class PerformanceMetricsController extends Controller
{
    ...
    // Redis keys
    public const METRICS_KEY = 'performance:metrics';

    public const ALERTS_KEY = 'performance:alerts';

    public const SUMMARY_KEY = 'performance:summary';

    public const USER_SESSIONS_KEY = 'performance:sessions';
