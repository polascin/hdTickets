...
class AdvancedAntiDetectionService
{
    ...
    protected function normalRandom(float $mean, float $stddev): int
    {
        ...
        if ($hasSpare) {
            $hasSpare = false;
            return intval($spare * $stddev + $mean);
        }
        ...
        return intval($mag * sin(2.0 * M_PI * $v) + $mean);
    }
