      ...
      '/<form[^>]*>/i',
        ...
        */
        ...
        'title' => 'required|string|max:255|regex:/^[a-zA-Z0-9\s\-\.,!@#$%&*()_+={}[\]:";\'<>?,.\\/]+$/',
          ...
          'sport_type' =>
          'required|string|in:football,basketball,baseball,soccer,tennis,cricket,rugby,motorsport,other',
          ...
          */
          ...
          throw new InvalidArgumentException('Input contains potentially dangerous content and has been rejected for
          security reasons.');
          }
          }
          }
