...
return [
    ...
    */
    ...
    | is set to the application timezone specified in your environment.
    |
    */
    ...
    | safely modified to any of the locales which will be supported by
    | your application.
    |
    */
    ...
    | the locales which will be supported by your application.
    |
    */
