...
Route::middleware(['auth:sanctum', 'track.user.activity'])->group(function (): void {
    /*
    |--------------------------------------------------------------------------
    | Notification Preferences
    |--------------------------------------------------------------------------
    */
    Route::prefix('notifications/preferences')->name('api.notifications.preferences.')->group(function (): void {
    ...
    |--------------------------------------------------------------------------
    */
    Route::prefix('notifications/channels')->name('api.notifications.channels.')->group(function (): void {
    ...
    |--------------------------------------------------------------------------
    */
    Route::prefix('enhanced-alerts')->name('api.enhanced-alerts.')->group(function (): void {
    ...
    |--------------------------------------------------------------------------
    */
    Route::prefix('analytics')->name('api.analytics.')->group(function (): void {
        // User analytics
