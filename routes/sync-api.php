...
Route::middleware(['auth:sanctum', 'throttle:sync'])->prefix('sync')->group(function (): void {
...
Route::middleware(['auth:sanctum', 'throttle:refresh'])->prefix('refresh')->group(function (): void {
