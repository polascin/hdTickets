...
class AuthSecurity {
    ...
    setupSkipNavigation() {
        // Create skip navigation links if they don't exist
        const skipNav = document.createElement('div');
        skipNav.className = 'hd-sr-only';
        skipNav.innerHTML = `
            <a href="#login-form" class="skip-link">Skip to main content</a>
            <a href="#email" class="skip-link">Skip to login form</a>
        `;
